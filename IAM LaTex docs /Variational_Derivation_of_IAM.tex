...
\begin{equation}
-3H\left(1 + w_\text{info}\right) = -3H\left(1 - 1 - \frac{1}{3a}\right) = -3H\left(-\frac{1}{3a}\right) = \frac{H}{a} \;\;\checkmark
\end{equation}
...
\begin{tabular}{lccc}
\hline
Experiment & $\sigma(\mu_0)$ & S/N for IAM & Reference \\
\hline
DESI DR1 (current) & 0.22 & 0.6$\sigma$ & \cite{DESIDR1FS} \\
DESI Year 5 (projected) & $\sim$0.08 & 1.7$\sigma$ & scaling \\
Euclid (GC$_\text{s}$+WL+XC, optimistic) & $\sim$0.04 & 3.4$\sigma$ & \cite{EuclidForecast2024} \\
Euclid + DESI Y5 (combined) & $\sim$0.03 & 4.5$\sigma$ & combined \\
\hline
\end{tabular}
\end{center}
