...
def sec8_procedures(story):
    ...
    proc(story, 'PROC-CMB-01 -> 04 - the patient\'s sky: four seals, row 4.6 withheld on C2\'', 'A healthy sky is quiet at 2.6-3.2%, not 5%; the constant travels with every plate', [(k, dict(D.CMB_PROC)[k]) for k in dict(D.CMB_PROC)])
