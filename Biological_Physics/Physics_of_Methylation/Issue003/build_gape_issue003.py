...
def sec8_procedures(story):
    ...
    proc(story, 'PROC-MATCH-01 - row 8 OPEN: disease matching fails closed, sees almost nothing, and says so', 'Not yet tested, never cannot', [(k, dict(D.MATCH_PROC)[k]) for k in dict(D.MATCH_PROC)])
