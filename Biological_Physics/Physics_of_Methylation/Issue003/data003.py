...
CHAIN01 = {
 ...
 "findings": [
  ...
  ("DEFECT 1 - stem_adult false alarm", "stem_adult reads BREACH (A 1.10-1.13, ABOVE_BAND) in 7/7 whole-blood samples including every healthy donor. Fraction 3.8-4.4% passes DETECT_FLOOR 0.01 (fails the 3% adjudicator gate only marginally). Its age band is n=28 from one source (Adelman 2019; A_mean 0.956, p10-p90 0.922-0.991) - a cohort statistic, not a floor. A class that flags every healthy donor is a broken BAND, not a finding. Until the band is rebuilt (Phase 1) stem_adult must be NOT_ASSESSABLE from whole blood."),
