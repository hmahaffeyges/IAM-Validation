...
REFERENCE_LAYERS = {
 ...
 "layers": [
  ("LAYER 1 - THE FLOOR", "H_min per class, from physics (G-002 MCMC on 37 published reference methylomes; bootstrap 8/8, PROC-HMIN-BOOT-01). Universal. Frozen 2026-04-06; not refitted since. The commitment line A = 1.000 is the floor.", "one number per class, forever"),
