...
CMB_PROC = [("question","Can a patient's sky be drawn against a healthy expectation, and is a healthy person's sky quiet?"),
 ...
 ("standing","Row 4.6 COMMISSIONING WITHHELD: the sealed procedure computed row_4_6_commissioned = False. Analyst recommendation to the author: commission with the constant stated on every sky (a healthy sky is quiet at 2.6-3.2%, not 5%), or re-seal CMB-05 at [0.025,0.08]. The sky code and the four laboratory scales are in the chain; the row is not declared commissioned until the author rules.")]
FALSIFICATION += [("PROC-CMB-04 C2' (2026-09-21)", "held-out healthy tail bar [0.03,0.08] in >=3/4 labs; measured 0.029/0.026/0.032/0.029 - scale ~1.1x conservative", "FAIL as sealed; recorded; row 4.6 WITHHELD pending the author's ruling"),
...
TIER_PROC = [("question","Do the Stage 7 tier words follow one definition, only on a reportable gauge, and where do healthy people fall under them?"),
 ...
 ("standing","Row 7 COMMISSIONED (T1, T3, T4). The 1.01 onset is NOT changed by this procedure: the Warburg and breach lines are clean of healthy people; the onset is the author's ruling - restore 1.04, set it at the band p90 (1.025), or keep 1.01 with '30% of healthy read ELEVATED' printed on every report.")]
