...
SEP_03 = {
 ...
 "result": "7/7 whole-blood test samples: SPLIT, kappa 3.9-5.2, progenitor = the whole compartment (0.07-0.20), stem_adult = 0.000. Tissue with no haematopoietic-progenitor mass: COMPARTMENT_ONLY, kappa = inf, 'nothing to split' (correct). CRC-1 tissue: SPLIT 0.010 / 0.004.",
