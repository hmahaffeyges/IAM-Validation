...
FALSIFICATION += [("PROC-AGE-01 A1: 'cellular age from the identity gauge places >= 80% of healthy adults within +/-10 yr'", "15.9% (median |delta| 35.6 yr); slope 0.47 mA/yr vs within-lab SD 0.0235 -> ~50 yr per array; the analyst's own prediction (30 +/- 8 yr) was too optimistic", "FAIL as sealed; Stage 6 CLOSED, NOT REPORTABLE at single-array resolution; the report prints the resolution; the gauge measures fidelity, not time"),]
...
AGE_PROC = [("question","Can the identity gauge, whose healthy curve rises with age, be inverted to read a person's cellular age?"),
 ...
 ("correction","Stage 6 CLOSED as NOT REPORTABLE at single-array resolution: the report prints the resolution sentence instead of an age; the marker-union inversion is diagnostic only. With this, no reported number in the chain reads the marker-union statistic. The gauge measures fidelity, not time; a clock is a different instrument and outside this document's claim.")]
