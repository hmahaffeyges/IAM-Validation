...
SEP_01 = {
 ...
 "remedy": [
  ...
  ("3 - independent HSC references (needs data)", "a second sorted-HSC source from a different laboratory breaks the shared-donor coupling. The funding ask, and a small one."),
 ],
 "framing": "Not a failure: a class-boundary problem no cohort could see, located by a linear-algebra diagnostic from map-making, with a measured cause and a costed fix. Goes in the ledger when step 1 lands.",
}
