...
FALSIFICATION += [("PROC-CMB-04 C2' (2026-09-21)", "held-out healthy tail bar [0.03,0.08] in >=3/4 labs; measured 0.029/0.026/0.032/0.029 - scale ~1.1x conservative", "FAIL as sealed; recorded; row 4.6 withheld until PROC-CMB-05 passed the restated bar 4/4 the same day"),
                  ("PROC-CMB-03 C4' render-cap bar (2026-09-21)", "'<=3 healthy test arrays render a non-blood class' assumed a fixed composition for healthy blood (secretory, cycling, terminal absent) - a prior about biology, not a test of the gate; RETIRED", "RETIRED by the author same day"),
...
MATCH_PROC = [("question","Does Stage 8 disease matching run on the commissioned chain, fail closed, and see a patient?"),
 ...
 ("standing","ROW 8 OPEN. Gate: a per-cell healthy reference on the separation surface from the four-lab panels (level and spread, laboratory-zeroed), the signature matrix re-expressed against it, then a re-seal. run_full carries Stage 8 as diagnostic_disease_matching, reportable=False. Disease matching on the commissioned chain is NOT YET TESTED.")]
FALSIFICATION += [("PROC-CMB-05 C2' (2026-09-21)", "bar restated [0.025,0.08]; prediction 4/4 labs", "PASS 4/4 (0.029/0.026/0.032/0.029); row 4.6 commissioned by the script's verdict"),
                  ...
                  ("PROC-MATCH-01 M5 (2026-09-21)", "prediction: <10 present cells enter Stage 8's departure profile on healthy whole blood", "0-5 cells, median 3 - PREDICTION CORRECT; row 8 OPEN, gate named"),
                  ("PROC-MATCH-01 M1 (2026-09-21)", "origin gate fell back to {} on a missing file (fail-open)", "FIXED: fail-closed, kit test")]
