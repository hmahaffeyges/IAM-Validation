...
| **Operating procedure** | [`SOP/CPG_Chain_of_Custody_SOP_v1_5_0.md`](SOP/CPG_Chain_of_Custody_SOP_v1_5_0.md) | the chain stage by stage; §105 (per-locus entropy on marker panels) and §106 (one aggregation per surface) are the two rulings a reader most needs |
