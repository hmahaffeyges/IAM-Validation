...
| **The translation map** | [`CMB_TO_METHYLOME_MAP.md`](CMB_TO_METHYLOME_MAP.md) | 78 CMB-analysis modules mapped to their methylome analogs by the author before the chain was built, with a 2026-09-19 status column: what got built, what was reversed (a second deconvolver; de-aging) and why |
