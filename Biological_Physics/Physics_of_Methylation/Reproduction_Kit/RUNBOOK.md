...
Pre-flight check: for every cohort, compute healthy-immune β̄ on the identity loci and compare to 0.737 (Roadmap). A departure > 0.01 without a matching entry in  halts absolute reporting for that cohort.
