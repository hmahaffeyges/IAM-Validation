...
2. **Identity loci frozen** (7b74f36). `iamatlas_gauge_identity_loci_v1_0.json`: per-class loci selected where the class sits at its characteristic β (unimodal), 20k–42k per class, with `H_min_beta` and a ±0.05 band.
