# CPG_VAL_014_AD_GIFT_specificity — Pre-Registration

**VAL ID:** CPG_VAL_014_AD_GIFT_specificity
**Title:** AD-immune specificity arm — AD vs FTD vs PSP/CBD vs HC (GIFT)
...
- **Source:** GSE53740 GIFT
- **n_case (ad):** 15
- **n_hc (hc):** 193

## Signal

- **Signal column:** `Mahalanobis hyper-volume (AD vs HC primary; PSP vs HC secondary)`
- **Effect direction expected:** AD strong positive; PSP/CBD BELOW HC (confirms v2.2 BELOW_NORMAL); FTD intermediate
...
- **Cohen's d (observed):** +0.681
- **Primary N1 null p-value:** 0.027
- **Result narrative:** AD d=+0.681 (p=0.0006); PSP d=-0.380 (p=2e-6); FTD d=+0.279 (p=0.11)

## Interpretation

PASS — AD signal exceeds null at p=0.027. PSP signal also passes (p=0.034). Tauopathy differential confirmed.
...
- `CPG_VAL_014_OUTCOME.md` — full outcome narrative
...
- Sealed reproducer script (`cpg_val_014_ad_gift_specificity.py`)
