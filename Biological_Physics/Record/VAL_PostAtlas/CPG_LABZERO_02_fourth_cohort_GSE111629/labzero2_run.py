...
def main():
    ...
    W = WaltherIAMDeconvolver(os.path.join(E, "../MethylPhys/atlas/IAMAtlasREBUILD.csv"), celltype_class_map=os.path.join(E, "../MethylPhys/atlas/IAMAtlasREBUILD_celltype_to_class.json"), verbose=False)
