...
## Atlas
The runtime atlas `MethylPhys/atlas/IAMAtlasREBUILD.csv.xz` is included here. The per-class brightness
archives are in `MethylPhys/atlas/iamatlas_class_archives/`. These are identical to CPG_CMB_v1 and to
