...
**Amended:** 2026-04-28 (v2.3: early-onset rectal subsection three-VAL chain added under crc-epic v2.4. VAL-098 TCGA-READ paired tumor/adjacent-normal cycling-class scoring (n=7 paired, d=+0.612 [+0.227, +1.882]) extends VAL-062 TCGA-COAD anchor +0.724 to the rectal subsite. VAL-099 TCGA-COAD age-stratified re-analysis (n=26 paired, pooled d=+0.7241 reproduces VAL-062 byte-for-byte; under-50 stratum n=3 mean ΔA=+0.0357 descriptive-only per CHK-2.7) confirms direction concordance in the colon arm under-50 stratum. VAL-100 GSE282666 under-50 buffy-coat polyp Stage 1 immune (n=51 EPIC v2.0) is deferred to v0.2+ raw-IDAT processing per CHK-3.1 data integrity flag (supplementary file is minfi noob-bg-corrected output, not raw β; matches VAL-077 cookbook precedent). CCL-039 LL-MARKER-CPG-TILE-FIDELITY confirmed cookbook-wide on three independent paired tumor/adjacent-normal cohort configurations (TCGA-READ Colon_epithelial_cells tile d=−2.501; TCGA-COAD revisit d=−1.552; TCGA-COAD VAL-099 reproduction d=−1.603). CHK-4.11 logged. crc-epic v2.4 validation tier `cycling_class_tissue_validated_with_rectal_subsite` is established by VAL-098 + VAL-099; under-50 blood-arm confirmation is a v0.2+ task. EDEAR commercial deployment unaffected per CCL-037.)
**Amended:** 2026-04-28 PM (v2.3: VAL-101 hcc-epic 25-tile etiology stratification on TCGA-LIHC HM450 paired tumor/adjacent-normal sealed at `O5_DATA_INTEGRITY_FLAG` per pre-locked CHK-3.1 trip (extreme 26.6% < raw-EPIC threshold of 30%; middle 9.1% < 10% passes). Biological readouts descriptive supplementary only — do NOT propagate to hcc-epic card. hcc-epic card stays at v0.2. VAL-102 attempt to re-seal with TCGA HM450 platform threshold (extreme >20%) was identified as post-hoc threshold accommodation derived from VAL-101's tripped data and VOIDED at 2026-04-28T20:35Z within minutes of seal, before any execution. Audit trail at `Biological_Physics/validation_runs/VAL-102/VOIDED_BEFORE_EXECUTION.md` (original SHA `2b77ad9d3b69554a0658260756db0f08722e2be3fa96eb48aad9213974f4717c`). CCL-041 LL-CHK-3.1-PLATFORM-CALIBRATION formalized: CHK-3.1 thresholds need platform-specific tuning; TCGA HM450 platform threshold itself remains TBD pending a future calibration VAL on a structurally-separated cohort. The cookbook does not delete sealed records; it marks them and explains. The same-day catch demonstrates prereg discipline operating as designed against same-day temptations to bend the protocol when biology looks exciting.)
**Amended:** 2026-04-30 (v2.5: prostate-epic v0.2 → v0.3 promoted to multi_modal_validated_plus_multi_atlas_calibrated via VAL-117 ProstateRef Phase B calibration on TCGA n=210 + VAL-118 multi-atlas Phase C re-scoring on GSE269244 n=238 EPIC 850K; ProstateRef CpG-bridged matrix added to atlas_vault as the third successful EpiSCORE bridge alongside HeartRef and BreastRef; DISC-PROSTATE-001/002/003 sealed; CHK-2.7 added to TESTING_CHECKLIST requiring magnitude-based |d| thresholds with direction labels for all cell-of-origin atlas preregs; CHK-2.8 added requiring substrate-floor-based CHK-3.1B coverage thresholds (NOT default 95%); LESSONS_LEARNED gains prostate-LL-006/007/008. v2.4 amendment chain content preserved verbatim.)
**Amended:** 2026-05-01 (v2.6: bladder-epic v0.1 sealed (VAL-119 + VAL-120 + VAL-121 + VAL-122) at multi_modal_validated_plus_multi_atlas_calibrated tier. VAL-119 EpiSCORE BladderRef CpG-bridged Phase B calibration on TCGA-KIRC + TCGA-PRAD adjacent-normal n=210 sealed O1 (max within-cohort tile range 0.0694; gene-promoter atlas family separates cleanly with only 4 cell types — DISC-BLADDER-001 sealed: cell-type DISTINCTNESS not COUNT is the discriminating variable for gene-promoter atlas family fitness; extends DISC-CARDIO-004 + DISC-PROSTATE-001). VAL-120 Stage 1 Xu-538 on TCGA-BLCA n=440 sealed O4 — Xu-538 panel cohort-substrate per-sample coverage 51.1% pass at ≥80% threshold (panel was breast-derived; transferability flagged); diagnostic Stage 1 paired d=+1.8977 (n=21, p=3.14e-08) reported as diagnostic-not-sealed. VAL-121 Stage 2 multi-atlas sealed O2_DIRECTION_AMBIGUOUS — Loyfer bulk Bladder tile +1.91 POSITIVE vs EpiSCORE BladderRef Epi tile −1.46 NEGATIVE on same n=21 paired pairs; CHK-3.2 cross-tile sanity flagged ALL 14 Loyfer non-bladder solid-tissue tiles uniformly POSITIVE +2.34 to +2.92 confirming substrate-distribution mismatch on bulk-WGBS atlas; BladderRef Epi NEGATIVE satisfies CCL-039 cell-of-origin direction expectation (urothelial dedifferentiation, structurally consistent with prostate VAL-118 LE pattern). DISC-BLADDER-003 sealed: bulk-WGBS atlases on mucosal-cohort substrates produce inflated cross-tile A-scores; multi-atlas readings on mucosal cohorts MUST include a gene-promoter sub-cell-type atlas as primary cell-of-origin reader. VAL-122 Stage 3 immune fine-tune sealed O1_IMMUNE_DIFFERENTIATING — all 6/6 Salas IDOL tiles fire POSITIVE |d| range 0.49 to 1.24 consistent with mixed TIL+TAM+MDSC infiltration of muscle-invasive bladder tumor microenvironment; pure lymphoid-dominant or pure myeloid-dominant lineage-skewed signatures did not fire — broad infiltration pattern characteristic of MIBC. Phase C original prereg-locked CHK-3.1A floor f_extreme≥0.50 (kidney+prostate-derived from VAL-106) failed on 76% of bladder samples; honest amendment 002 (sealed AFTER β observed with full disclosure per CCL-041 second-best path) corrected the floor to bladder-cohort q1/q99 (f_extreme≥0.387, f_middle≤0.184) — DISC-BLADDER-002 sealed: CHK-3.1A floors are tissue-class-dependent; mucosal organs require different brackets from solid parenchyma. CHK-2.16 added to TESTING_CHECKLIST.md (tissue-class CHK-3.1A floor verification at prereg-write time). DISC-BLADDER-004 sealed: Stage 1 panel cohort-substrate-coverage transferability is cohort-specific not platform-specific. CHK-2.17 added to TESTING_CHECKLIST.md (Stage 1 panel cohort-substrate coverage validation at prereg-write time). EDEAR_PIPELINE_OFFICIAL_REFERENCE_v2.md gains Part 23 (tissue-class CHK-3.1A floor specification) and Part 24 (Stage 1 panel cohort-substrate coverage validation). Atlas vault INVENTORY.json updated with EpiSCORE BladderRef as the fourth successful EpiSCORE bridge alongside HeartRef + BreastRef + ProstateRef (90 → 94 entries). LESSONS_LEARNED.md gains DISC-BLADDER-001 through DISC-BLADDER-004 (1407 → 1496 lines). GitHub commit 404eed3 on hmahaffeyges/IAM-Validation main pushes 55 files (4 atlas vault files + 4 VAL directories with prereg + amendment + outcome + script + results JSON + per-sample CSV + cohort manifest + clinical metadata + stratified results each + unified runner + post-pass). v2.5 prostate amendment chain content preserved verbatim.)
**Version:** v2.6 (additive update preserving v2.5 / v2.4 / v2.3 / v2.2 / v2.1 / v2.0 content unchanged)
...
1. `breast-epic/` — Breast cancer pre-diagnostic detection. Stage 1 Xu-538 pooled A_immune positive direction (d = +0.45 to +0.71 on GSE51057 and GSE51032), Stage 2 localizes to breast_ductal. **VAL-060 tissue arm added in v2.2 (2026-04-24):** TCGA-BRCA HM450 matched tumor-vs-adjacent-normal (n=89/89, 86 complete pairs) paired d = +0.676 tumor vs adjacent-normal, p = 0.0001, unpaired d = +0.745 [+0.451, +1.075]. Breast-epic is now validated across three substrates (blood pre-dx, adjacent-normal tissue field effect, tumor tissue) with the same Xu-538 panel and same H_min(immune). First retroactive per-card tissue re-validation under CCL-011. **VAL-093/094/095/096 added in v2.3 (2026-04-26):** Stage 2 25-tile run on the same EPIC-Italy cohorts established the distributed-then-localized two-component temporal pattern (VAL-093 + VAL-096) — pancreatic + cycling-class tile elevation persists at all pre-dx windows in both cohorts with the breast tile localizing to d=+0.43/+0.49 only at 0-2yr. UniLIFE 19-cell vs Salas 6-cell head-to-head Stage 3 (VAL-095) surfaces two replicating resolution gains: aTreg at >10yr (d=+1.26/+0.79, both 95% CIs exclude zero) and aBnv at 0-2yr (d=+0.44/+0.49). EpiSCORE BreastRef sub-cell-type resolution (VAL-094) does not separate at buffy-coat input — 7 sub-cell types behave as one coherent signal (resolution-collapse). Card-internal lessons breast-LL-005/006/007 documenting these patterns. Run-everything Stage 3 architecture finalized: Salas remains production, UniLIFE added as parallel adult-specific subtype overlay.
...
5. `prostate-epic/` — Prostate cancer stage_2_only_validated flag. **VAL-058 is the first card with its own tumor-vs-adjacent-normal tissue validation run** (GSE269244 n=238 African-American men, Berglund/Yamoah/Kresovich 2024, EPIC 850K): unpaired d = +0.400 [+0.146, +0.659] p = 0.003; paired d = +0.497 on 118 matched pairs p = 0.0001; 481/538 Xu-538 EPIC coverage. Fills the clinical gap for patients whose Stage 1 flags and Stage 2 Moss NNLS returns prostate_epithelial. Does NOT claim pre-diagnostic blood screening for prostate — early-stage localized prostate cancer sheds minimally into plasma ccfDNA; urine specimen pathway not yet integrated (v0.2+ upgrade). African-American cohort only; European/Asian ancestry validation pending. No Stage 1 blood immune-class per-patient validation exists for prostate; Health ABC and Rotterdam Study remain dbGaP-gated. **VAL-065 urine arm attempted 2026-04-25 on GSE119260 (Brikun 2018), the only public EPIC 850K urine methylation prostate cohort on GEO — n=4 advanced-disease (all bone metastatic, Gleason 4+4 to 5+5, PSA 10.9 to 1400 ng/mL).** Tumor vs benign paired d = −0.016 at n=4 (the expected positive tumor signal from VAL-058's n=238 is not recoverable at n=4); urine vs benign paired d = −2.39 in unexpected direction (urine A-score lower than benign tissue in all 4 patients); plasma vs benign paired d ≈ 0; classified O5_UNEXPECTED per pre-reg ("urine vs benign d > 0.3 but in NEGATIVE direction... convene with Heath before deciding card update direction"). Treated as exploratory open question — no card direction taken on urine substrate. Card validation tier UNCHANGED (remains stage_2_only_validated, anchored by VAL-058). Priority-1 unmet data need: larger urine methylation prostate cohort with healthy controls and mixed disease stages (CCL-026). **v0.3 promoted 2026-04-30 to `multi_modal_validated_plus_multi_atlas_calibrated` via VAL-117 + VAL-118.** VAL-117 = EpiSCORE ProstateRef gene-promoter atlas CpG-bridged to 2,603 unique 450K CpGs × 6 prostate cell types (BE basal epithelial / EC vascular endothelial / Fib fibroblast / LE luminal epithelial / Leu intra-prostatic leukocyte / SM smooth muscle), calibrated on TCGA HM450K sesame Level 3 adjacent-normal n=210 (KIRC + PRAD; same calibration cohort that anchored cardio VAL-106/107/112/113). All three CHK gates clear: CHK-3.1A 206/210 (98.1%), CHK-3.1B 210/210 under amended ≥80% threshold per TCGA HM450K substrate floor (CHK-2.8 cookbook-wide rule formalized via VAL-117 amendment), CHK-3.1C 0 duplicates. Per-tile healthy-floor distributions sealed (LE tightest: mean 0.4254, sd 0.0041, q5 0.4190). ProstateRef does NOT collapse to tissue-floor-dominated like cardio HeartRef did — DISC-PROSTATE-001 sealed (gene-promoter atlas family fitness depends on per-tissue cell-type distinctness; extends DISC-CARDIO-004 / LL-CARDIO-005). VAL-118 = Phase C run-everything multi-atlas re-scoring on GSE269244 against five atlases (Xu-538 Stage 1 reproduction control + ProstateRef + Layered Moss+Loyfer 17-tile subset + UniLIFE 19-cell + Salas IDOL Stage 3). Stage 1 Xu-538 reproduces VAL-058 sealed (paired d = +0.5258 vs sealed +0.4973, within ±0.10 tolerance; β matrix bit-for-bit verified). **Headline finding: ProstateRef LE tile reads tumor at d_paired = −0.767 (large negative, luminal dedifferentiation pattern); other 5 ProstateRef tiles all positive: BE +0.477, EC +1.284, Fib +1.311, Leu +0.999, SM +1.092. Five-vs-one direction split is the prostate cancer methylation-architecture signature.** Stage 3 Salas IDOL Mono d_paired = +0.771; Bcell +0.674, CD4T +0.659, NK +0.645, CD8T +0.587 — broad TIL infiltration consistent with Berglund 2024 published CD40/OX40L/STING DMRs. UniLIFE 19-cell confirms at lower magnitudes (aMono +0.467, aNeu +0.433). **VAL-118 first execution sealed O5_LE_DIRECTION_FLIP_UNANTICIPATED** because original prereg pre-locked O2 as positive direction only; CCL-041 amendment changed threshold to magnitude-based |d| ≥ 0.30 with direction labels (LE_POSITIVE / LE_NEGATIVE), sealed BEFORE re-execution; re-execution sealed **O1_MULTI_ATLAS_CONVERGENT + O2_LE_TILE_DIFFERENTIATING (LE_NEGATIVE) + O4_STAGE_3_IMMUNE_SHIFT_PROMINENT** cleanly. Both outcomes preserved in audit trail. **DISC-PROSTATE-002 sealed: cookbook-wide rule formalized as CHK-2.7 — cell-of-origin atlas preregs MUST use magnitude-based |d| thresholds with direction labels** when biological direction-ambiguity is possible. **DISC-PROSTATE-003 sealed: A_LE BELOW VAL-117 healthy-floor q5 = 0.4190 is the operational diagnostic for v0.3 tissue-substrate disease scoring** + post-treatment trajectory monitoring. v0.2 limitations preserved unchanged: pre-diagnostic blood screening (FitzGerald 2017 MCCS pre-dx + Howard AA EPIC remain v1.0+ next-validation-steps, both biobank-gated); multi-ancestry generalizability (anchor cohorts 100% AA men); Gleason aggressiveness stratification (descriptive-only stratified-results JSON shows LE-negative pattern across all three Gleason grade groups but is NOT a v0.3 claim — aggressiveness card extension deferred to v0.4); early-stage localized plasma ccfDNA detection underpowered; urine substrate clinical pathway VAL-065 n=4 ceiling (CCL-026 open question unchanged). v0.3 commit chain on `hmahaffeyges/IAM-Validation`: `40ce175` (VAL-117) → `edf6229` (VAL-118 first execution sealed O5) → `58ecd16` (VAL-118 amendment) → `c5ee9d5` (Phase D v0.2-vs-v0.3) → `388e5b0` (cohort manifest, clinical metadata, stratified results, public Biological_Physics/README.md update).
...
## v2.3 update — VAL-098 + VAL-099 + VAL-100 early-onset rectal subsection three-VAL chain + CCL-039 (added 2026-04-28)

**VAL-098 — TCGA-READ paired tumor/adjacent-normal cycling-class scoring (2026-04-28).** First rectal-subsite tissue arm validation under crc-epic. n=7 paired pairs (TCGA-AG-3725, -3731, -A01W, -A01Y, -A020, -A02N, -A036; 6 Rectum NOS + 1 Rectosigmoid junction). Methodology mirrors VAL-062 TCGA-COAD anchor exactly: full-HM450 valid CpGs per sample scored against H_min(cycling) = 0.856055, RNG seed 20260428, prereg SHA `57d830d6c7ba6448...` sealed before β-value access. Within-cohort paired comparison — CHK-3.8 condition 1 satisfied, no cross-cohort calibration problem.

**Pooled paired Cohen's d = +0.612 [+0.227, +1.882], t = 1.62, p = 0.157.** Direction confirmed in rectal subsite. Magnitude consistent with VAL-062 TCGA-COAD anchor (+0.724) within bootstrap variation. 95% CI lower bound exceeds zero. Under-50 stratum n=1 (TCGA-AG-A01Y, 49.6y, Stage II Rectum NOS) ΔA = +0.016, pre-locked direction-only descriptive-only per CHK-2.7. Outcome label `O1_CYCLING_CLASS_RECTAL_CONFIRMED`. crc-epic validation tier promoted to `cross_platform_validated (blood) + cycling_class_tissue_validated (tissue, VAL-062) + cycling_class_tissue_validated_with_rectal_subsite (VAL-098 + VAL-099, 2026-04-28; under-50 blood-arm via VAL-100 deferred to v0.2+ raw IDAT processing per CHK-3.1)`.

**VAL-099 — TCGA-COAD age-stratified re-analysis (2026-04-28).** No new data download — re-execution of VAL-062 cycling-class methodology on the same 26-pair cohort (cached .txt files), plus run-everything 25-tile per-class A-score, plus stratified analysis by age decile, anatomic subsite, and sex. Prereg SHA `8e4ee02c59774514...` sealed before re-scoring. Pooled paired d = **+0.7241 [+0.352, +1.296]**, t = 3.69, p = 2.2e-04 — reproduces VAL-062 anchor +0.7241 byte-for-byte (drift = −3.3e-05, within ±0.05 RNG drift tolerance). Under-50 stratum (n=3: TCGA-A6-2685 48.6y, TCGA-A6-5667 40.4y, TCGA-AA-3663 42.9y) reads mean ΔA = +0.0357 — descriptive-only per CHK-2.7; direction descriptively positive, concordant with pooled positive direction. Age 50+ stratum (n=21) reads paired d = +0.539, inferential. By-subsite: Ascending colon n=8 d=+0.387, Cecum n=5 d=+1.094, Colon NOS n=5 d=+1.702 (all positive at adequate sub-stratum power); Sigmoid colon n=3 mean ΔA=−0.0015 (descriptive). One anomaly flagged: TCGA-G4-6625 has tissue_or_organ_of_origin = "Skin, NOS" in GDC clinical metadata, included consistent with VAL-062 inclusion. Outcome `O1_AGE_STRATIFIED_DIRECTION_CONFIRMED`. Provides under-50 colon stratum descriptive direction signal at modest n.

**VAL-100 — GSE282666 under-50 buffy-coat polyp Stage 1 immune (2026-04-28, DEFERRED).** Cohort: Kumar 2024, n=51 EPIC v2.0 (GPL33022), all under age 50, with same-day colonoscopy PNP+/PNP- status (16 PNP+ / 35 PNP-). First VAL on EPIC v2.0 (GPL33022) in the entire cookbook. Xu-538 panel coverage 484/538 = 90.0%. Prereg SHA `4017913d31b31e03...` sealed before β-access. Pre-locked CHK-3.1 beta distribution check **failed**: extreme 3.9% / middle 6.8% (raw β bimodal signature requires extreme >30% AND middle <10%). Supplementary `GSE282666_Betas.csv.gz` is minfi v1.40.0 noob-bg-corrected output per Kumar 2024 Methods, not raw β. CHK-3.2 cross-cohort baseline check independently confirms: PNP- mean A_immune = 0.807 vs Italian healthy anchor 0.438 = +15.13 anchor-SD offset (off-spec scale). Observed d = +0.236 [−0.363, +0.919] descriptive-only — NOT interpreted under CCL-032 diagnostic order (data integrity → biology → framework). Outcome `O5_DATA_INTEGRITY_FLAG`. Same pattern as VAL-077 (cervical-LBC GSE287994 supplementary file = batch+chip+age+HPV-corrected residual M-values per Bowden 2025 Methods, deferred to v0.2+). Cookbook precedent: defer the VAL to v0.2+ raw IDAT processing of `GSE282666_RAW.tar` through minfi or sesame (~2-4 hour task; IDATs are deposited, no biobank application required). The under-50 blood-arm direction expectation is unestablished at v1 — the cohort design is right; the public processed-betas-supplementary file is not the right substrate for the cookbook Stage 1 methodology.

**Atlas resolution constraint.** v1 Loyfer atlas (production Stage 2) has Colon_epithelial_cells tile but no rectum-specific tile. Atlas vault check on 2026-04-28 surveyed every reference matrix in `Biological_Physics/atlas_vault/` (Loyfer 25-tile, EpiSCORE ColonRef 5 sub-cell-types, Caggiano CelFiE TIM, MARLIN, Sabedot GeLB, all Stage 3 immune atlases) — zero rectum-specific cell types anywhere. The early-onset rectal subsection is a clinical-action routing layer (age × family-history) on top of the existing colorectal cell-of-origin signal, NOT a rectum-vs-colon biology-detection card. Subsection promotes to standalone `rectal-epic` card when a future atlas with rectum-specific resolution becomes available (Liu 2023 brain scMCodes-style single-nucleus methylation, 223-cell-type WGBS atlas, GTEx-derived sigmoid-vs-rectum split).

**Hispanic stratification dropped from subsection per Heath direction 2026-04-28.** Subsection is about under-50 stratum, full stop. Clinical action routing uses age + family history; ethnicity is not in the EDEAR layer. The article that prompted the subsection build referenced rising rectal cancer incidence in young Hispanic populations in the western US; that population context is real but population-stratified biology is not what the data support at v1, and EDEAR fires the same red flag for all populations with elevated cycling-class colorectal architectural drift.

### CCL-039 LL-MARKER-CPG-TILE-FIDELITY (added 2026-04-28)

**Source:** VAL-098 + VAL-062 revisit (diagnostic re-application of VAL-098 run-everything 25-tile methodology to the existing VAL-062 TCGA-COAD 26-pair sealed dataset).

**Lesson:** Marker-CpG-tile A-score and full-HM450 architectural-drift A-score are two distinct observables that do NOT necessarily move in the same direction in tumor vs adjacent-normal paired comparisons.
...
Three independent paired-tumor-vs-adjacent-normal cohort configurations, three negative cell-of-origin tile readings, three positive full-HM450 cycling-class readings. Direction concordance across all 10 top-magnitude tiles between READ, COAD revisit, and COAD VAL-099 reproduction (Bladder +, Hepatocytes +, Lung +, Pancreatic_beta +, Colon_epithelial_cells −, Uterus_cervix −).

**Biology interpretation.** Full-HM450 cycling-class A-score (~485K CpGs averaged) measures global Shannon entropy change — every CpG counted equally, every signal direction averaged. Tumors increase entropy globally, A-score rises, paired d positive. Per-tile A-score on top-100 marker CpGs of Colon_epithelial_cells measures how strongly the sample looks like healthy colon at the colon-discriminating CpGs. In healthy adjacent-normal colon, those CpGs anchor to the colon-specific methylation pattern. In tumor, the colon-specific signature degrades as tumor architecture homogenizes and de-differentiates — the colon-discriminating CpGs lose their colon-specific β values and read more like a generic non-colon mix. A-score on those CpGs goes DOWN, paired d negative. The other tiles read positive because their marker CpGs (Bladder, Pancreas, Lung-discriminating CpGs) are CpGs where healthy colon is methylated very differently from those tissues; as tumor methylation homogenizes, those non-colon-specific CpGs drift toward the tumor methylation level.

**Embedded rule.** Future preregs that include run-everything 25-tile per-class A-score on tumor-vs-adjacent-normal paired comparisons must NOT pre-lock "cell-of-origin tile is largest |d|" as an O1 criterion. Pre-lock "cell-of-origin tile is among the largest |d|" instead, with explicit acknowledgment that direction depends on whether the comparison is tumor-vs-adjacent-normal-paired (cell-of-origin tile NEGATIVE due to fidelity loss) or healthy-tissue-vs-tissue cross-reference (cell-of-origin tile POSITIVE). See CHK-4.11 in `TESTING_CHECKLIST.md`.

**Cookbook-wide implication.** CCL-039 is currently confirmed on three independent paired tumor-vs-adjacent-normal cohort configurations (TCGA-READ VAL-098, TCGA-COAD VAL-062 revisit, TCGA-COAD VAL-099 reproduction) — all colorectal. The third confirmation in VAL-099 establishes cookbook-wide robustness within the colorectal cancer arm. Generalizability beyond colorectal cancer to other tissue arms requires future VALs to apply the same methodology to existing breast (VAL-060), lung (VAL-063), HCC (VAL-064), prostate (VAL-058) per-sample CSVs and verify the cell-of-origin tile direction is consistently negative in tumor-vs-adjacent-normal paired comparisons across cancer types. Until that work is done, CCL-039 is documented as a robustly-confirmed colorectal observation with a strong biological rationale for cookbook-wide generalization but not yet empirically confirmed beyond CRC.

### crc-epic v2.4 (2026-04-28)

crc-epic card promoted from v2.3 to v2.4. Additive update — v2.3 content (CCL-031 disambiguation block, CCL-027 four-question guard, validation tier, tissue arm with VAL-061/062, universal reference block, lessons_learned, corrections log) preserved unchanged. New top-level blocks added:

- `early_onset_rectal_subsection` — VAL-098 anchor + VAL-062 revisit confirmation + CCL-039 documentation + atlas resolution constraint + age-stratified clinical action matrix + 3 next_validation_steps + 5 known_limitations.
- `commercial_deployment_unaffected_by_validation_limitations` — inherited from lung-epic v0.5 standard per CCL-037.
- New `crc-LL-CCL-039` lesson appended to `lessons_learned.lessons` array.

Card JSON file: `crc-epic_card_v2.4.json`. Card README: `crc-epic_README.md` (v2.4 changelog block appended).

### Validation queue status post-VAL-098 + VAL-099 + VAL-100 (complete)

- **VAL-099 — TCGA-COAD age-stratified re-analysis ✅ COMPLETE.** Re-execution of VAL-062 cycling-class methodology on cached 26-pair cohort plus run-everything 25-tile plus stratification by age, subsite, sex. Pooled d = +0.7241 [+0.352, +1.296] reproduces VAL-062 byte-for-byte. Under-50 stratum (n=3) mean ΔA = +0.0357 descriptive-only per CHK-2.7 — direction concordant with pooled positive direction. Age 50+ stratum (n=21) paired d = +0.539 inferential. Outcome `O1_AGE_STRATIFIED_DIRECTION_CONFIRMED`. Provides under-50 colon stratum descriptive direction signal at modest n. Confirms CCL-039 at the third independent paired tumor-vs-adjacent-normal cohort configuration.

- **VAL-100 — GSE282666 Stage 1 immune A-score on under-50 buffy coat with colonoscopy-confirmed polyp status ⚠️ DEFERRED.** First VAL on EPIC v2.0 (GPL33022) in the cookbook. n=51 (16 PNP+ / 35 PNP-), all under age 50. Pre-locked CHK-3.1 beta distribution check **failed**: extreme 3.9% / middle 6.8%. Supplementary `GSE282666_Betas.csv.gz` is minfi v1.40.0 noob-bg-corrected output per Kumar 2024 Methods, not raw β. CHK-3.2 cross-cohort baseline +15.13 anchor-SD off confirms scale issue. Observed d = +0.236 descriptive-only — NOT interpreted under CCL-032 (data integrity → biology → framework). Outcome `O5_DATA_INTEGRITY_FLAG`. Same pattern as VAL-077 cervical-LBC. Defer to v0.2+ raw IDAT processing of `GSE282666_RAW.tar` (~2-4 hour task, no biobank application required). The under-50 blood-arm direction expectation is unestablished at v1.

- **Future-when-support-arrives:** GSE284325 EOCRC WGBS cohort (n=16) requires post-Caggiano methods translation engineering for WGBS-to-array mapping. Logged in `crc-epic/future_when_support_arrives.md`. Not pursued at v1 per LL-PUBLIC-TIER (no biobank applications, no preprint-first).

### Honest summary of crc-epic v2.4 evidence base

**Tissue arm direction:** confirmed at three independent cohorts (VAL-062 + VAL-098 + VAL-099, three-cohort consistency). **Tissue arm under-50 direction:** descriptively confirmed at n=4 combined (VAL-098 n=1 rectal + VAL-099 n=3 colon, all directionally positive, all descriptive-only per CHK-2.7) — not inferential. **Blood arm under-50 direction:** unestablished — VAL-100 deferred per CHK-3.1 to v0.2+ raw IDAT re-processing. **Card validation tier** `cycling_class_tissue_validated_with_rectal_subsite` is established by VAL-098 + VAL-099. **Blood-arm under-50 confirmation** is a v0.2+ task, honestly stated in the card commentary rather than pretended-complete.

---

## v2.3 update — VAL-101 hcc-epic 25-tile etiology stratification on TCGA-LIHC sealed at O5 + VAL-102 voided + CCL-041 (added 2026-04-28)

**VAL-101 — hcc-epic 25-tile etiology stratification on TCGA-LIHC HM450 paired tumor/adjacent-normal (2026-04-28).** Same patient list as VAL-064 sealed cohort, same QC thresholds, same methodology as VAL-098 / VAL-099 (run-everything Loyfer 25-tile per-class A-score with full etiology stratification). Pre-registered SHA `fa366bf00316597bb65032b747029133acb5f1bbb40f6251094b563732185512` sealed before β-access. Three pre-locked questions: (1) CCL-039 cross-tissue generalization to HCC; (2) viral-vs-non-viral blunting at the per-tile level vs the pooled-cycling-class level (where VAL-064 documented it); (3) Marcus-analog stratum characterization (No_documented_risk patients, n=10, the closest available public analog to aggressive HCC arising without one of the four canonical drivers — chosen because of the personal motivation: Heath's stepbrother Marcus died of an aggressive HCC without a documented chronic-driver risk factor).

**Outcome `O5_DATA_INTEGRITY_FLAG`.** Pre-locked CHK-3.1 thresholds (extreme >30%, the raw-EPIC default from VAL-100 prereg) tripped on TCGA-LIHC HM450 sesame Level 3 at extreme 26.6% / middle 9.1%. Per CCL-032 diagnostic order, cookbook discipline honors the trip. The biological readouts (Pooled Hepatocytes tile d = −1.521; All_viral d = −1.726; All_non_viral d = −1.393; No_documented_risk Marcus-analog d = −1.141) are descriptive supplementary documentation only and do NOT propagate to the hcc-epic card. The hcc-epic card stays at v0.2.
...
### VAL-102 voided before execution — self-correction logged

A VAL-102 prereg was sealed at 2026-04-28T20:31:23Z with a TCGA HM450 platform threshold (extreme >20%) derived from VAL-101's tripped data. The intent was to "do the prereg right the second time" by re-running the same methodology on the same cohort under a platform-tuned threshold. This was identified within minutes as post-hoc threshold accommodation with a SHA stamp — the threshold was selected to accommodate values already observed (extreme 26.6% in VAL-101, extreme 24.4% in retroactive VAL-099 verification). Sealing such a threshold and applying it to the same cohort is circular reasoning, not pre-registration. VAL-102 was voided at 2026-04-28T20:35Z, before any execution. Audit trail preserved at `Biological_Physics/validation_runs/VAL-102/VOIDED_BEFORE_EXECUTION.md` with the original SHA `2b77ad9d3b69554a0658260756db0f08722e2be3fa96eb48aad9213974f4717c`. The cookbook does not delete sealed records; it marks them and explains.

The same-day catch demonstrates the prereg discipline is operating as designed. The temptation to bend a sealed criterion is strongest exactly when the biology looks like it might say something that matters to a person. The void event is logged as a positive cookbook signal — institutional memory of the discipline working under pressure.

### CCL-041 LL-CHK-3.1-PLATFORM-CALIBRATION (formalized 2026-04-28)

**Lesson:** CHK-3.1 thresholds need platform-specific tuning. Raw EPIC β reads sharper bimodality than TCGA HM450 sesame Level 3 due to standard TCGA pipeline dye bias correction. The threshold for any new platform MUST be set by a calibration VAL on a structurally-separated cohort, NOT by retroactive accommodation of the data that triggered the discovery.

**Distinction from CCL-040** (preserve carefully). CCL-040 covers PROCESSED OUTPUT that loses bimodal raw β signature entirely (extreme 3.9% / middle 6.8% in VAL-100 GSE282666). CCL-041 is about raw-β bimodality manifesting at slightly different threshold values across raw-β platforms. Two distinct concerns; CCL-041 does NOT generalize CCL-040's deferral pathway.

**Platform-specific thresholds going forward:**
- Raw EPIC β / EPIC v2.0 β: extreme >30%, middle <10% (established VAL-100)
- TCGA HM450 sesame Level 3 β: TBD — calibration VAL needed on a structurally-separated cohort (TCGA-KIRC adjacent-normal, TCGA-PRAD adjacent-normal, etc.)
- Other platforms: TBD; document at first calibration VAL on platform

### Honest path forward for VAL-101 biological readouts

The biological readouts in VAL-101 results.json are real numbers. Their inferential validation pathway requires either (a) a calibration VAL on TCGA samples from a tissue NOT under active hcc-epic test that establishes the TCGA HM450 platform threshold, then a future hcc-epic VAL on TCGA-LIHC under the pre-registered platform threshold, OR (b) the CCL-040 raw-IDAT deferral pathway re-processing TCGA-LIHC .idat files through sesame and re-running with verified pipeline output. Both paths are multi-VAL workstreams. Neither is a same-day re-seal.

### hcc-epic card status post-VAL-101

**hcc-epic card stays at v0.2** (sealed 2026-04-24, anchored on VAL-059 ccfDNA + VAL-064 tissue arm). VAL-101 does NOT promote the card to v0.3. The biological readouts are descriptive supplementary only; they do not change the card's validation tier (`multi_modal_validated`), do not update the etiology stratification (already documented in v0.2 from VAL-064), and do not add the 25-tile observation as a card-level finding. The card's `next_validation_steps` priority 1 (non-HIV HCC ccfDNA cohort replication) is unchanged.

### EDEAR commercial deployment unaffected

Per CCL-037, VAL-101 + VAL-102-voided + CCL-041 are retrospective cookbook validation activity with no impact on EDEAR commercial deployment.

---

## v2.4 amendment — CHK-3.1A/B split convention + cardio-epic v0.1 first native build (added 2026-04-28)

The CHK-3.1 data-integrity check has been split into CHK-3.1A (full-genome substrate gate) and CHK-3.1B (card-specific marker subset gate). Both must pass. Full rationale at LESSONS_LEARNED CCL-042. Pipeline change documented at EDEAR_PIPELINE_OFFICIAL_REFERENCE Part 17. Testing methodology at TESTING_CHECKLIST CHK-3.1A/B section.

### First card built natively under split: cardio-epic v0.1

Phase 1 cardio testing complete:
- **VAL-106** TCGA HM450K sesame Level 3 CHK-3.1A baseline (TCGA-KIRC + TCGA-PRAD adjacent-normal n=210)
- **VAL-107** Cardio-epic CHK-3.1B threshold on 8,100-CpG marker subset (extreme≥55.0%, middle≤8.5%, n_subset≥7000)
- **VAL-108** GSE69138 ischemic stroke 3-subtype `O3_3SUBTYPE_UNDIFFERENTIATED` — biology-correct null on whole blood
- **VAL-109** GSE84395 PAH cultured PEC `O2_VASCULAR_TILE_DIFFERENTIATING` — Vascular_endothelial_cells d=+0.79 control vs hPAH
- **VAL-110** GSE84274 ascending aorta `O2_AORTIC_ANY_TILE_DIFFERENTIATING` — Stage 1 immune d=+1.08 normal vs BAV

Cardio-epic v0.1 card validation tier: `multi_modal_validated`. Four card-specific lessons formalized at CCL-043 in `LESSONS_LEARNED.md`:

- **LL-CARDIO-001** Substrate-cell match matters (substrate fitness lesson). Pure cell type → pure cell signal; mixed bulk tissue → mixed signal dominated by bulk's actual cell types. Future cards with cell-type-specific tiles must verify sample-tile fitness or the Stage 2 reading misrepresents biology.
- **LL-CARDIO-002** Whole blood does not stratify ischemic stroke by TOAST etiology (biology-correct null, not framework failure). The framework correctly reports that whole-blood methylation does not discriminate what biology has homogenized. This pattern generalizes to any setting where systemic inflammation homogenizes a peripheral substrate across disease subtypes.
- **LL-CARDIO-003** Heritable PAH > idiopathic PAH framework signal is biology-consistent (germline genetic component produces stronger methylation dysregulation than heterogeneous sporadic etiology). May generalize to other monogenic-vs-complex disease pairs.
- **LL-CARDIO-004** Aortic pathology is Stage 1 immune-detectable, Stage 2 vascular-tile-resistant on bulk substrate — universal Stage 1 immune flag is operational across all cardio substrates.

### Phase 2 cookbook-wide rollout (this amendment)

The CHK-3.1A/B split is the formal cookbook convention going forward. Documents updated:

- **TESTING_CHECKLIST.md** — CHK-3.1 section refined in place with split A/B subsection, platform threshold table updated (VAL-106 / VAL-107 values now resolve the prior TBD entries)
- **LESSONS_LEARNED.md** — CCL-042 (split convention) + CCL-043 (cardio biology lessons) added
- **EDEAR_PIPELINE_OFFICIAL_REFERENCE_v2.md** — Part 17 added documenting the split + first native build + Phase 1/2/3 rollout
- **README_MASTER** — this amendment (v2.3 → v2.4)
- **GAPE_Evidence_Report_UPDATED.html** — VAL-106 through VAL-110 entries already present per Bio Physics README inspection; retroactive split-classification footnotes for VAL-100 / VAL-101 / VAL-077 to be applied separately
- **GAPE_Reproduction_Paper_v1.md** — §7.20 to be added documenting the split rationale and cardio-epic v0.1 as first native implementation

### Phase 3 — Per-card retroactive review (pending Phase 2 sign-off)

After Phase 2 docs are signed off, every existing card gets its `universal_pipeline_acknowledgment.chk_3_1_thresholds_per_substrate` block extended with both CHK-3.1A platform thresholds (substrate-keyed) and the card-specific CHK-3.1B threshold for that card's marker union:

- breast-epic v2.3 → v2.4
- lung-epic v0.5 → v0.6
- ad-immune (next version)
- hcc-epic v0.3 → v0.4
- crc-epic v2.4 → v2.5
- kidney-epic, cervical-epic

These are additive documentation updates. No sealed VAL outcomes change. Sealed outcomes are honored as decisions made under the rules at the time, with retroactive reclassification logged as documentation only.
...
- Retroactive reclassification is documentation-only.
- EDEAR commercial deployment is unaffected per CCL-037. Deployment runs single calibrated patient-vs-internal-reference pipeline structurally insulated from public-cohort substrate diversity.

### Cardio-epic v0.1 deliverables (already staged + GitHub-pushed)

- `cardio-epic_card_v0_1.json` — 23-key card matching breast/hcc structural standard
- `cardio-epic_README.md` — 241-line README with full validation evidence summary, four card-specific lessons learned, and three CCL cross-references
- `Biological_Physics/validation_runs/VAL-106/` through `VAL-110/` — sealed prereg, outcome, results JSON, per_sample CSV, Python scripts, manifests on GitHub (commit `898c9ae`, pushed 2026-04-28)
- `Biological_Physics/README.md` — VAL-106 through VAL-110 entries with NIH GEO + GDC public data links and `nloyfer/meth_atlas` reference for full reproducibility

## v2.4 amendment — Cardio-epic v0.2 + VAL-111 + CHK-5.11 (added 2026-04-29)

VAL-111 sealed 2026-04-29 at `O3_TISSUE_FLOOR_DOMINATED` (prereg SHA `172c6ae2a11345935c176b4a1fc57d30009ad4bac9bb9cdeeb9c8226035b78a6`). Atlas: EpiSCORE HeartRef (Zhu et al. *Nat Commun* 2022 13:3895), gene-promoter cardiac reference matrix bridged to 3,727 unique 450K CpGs × 5 cardiac cell types (CM/EC/FB/MP/SMC), GPL-2 license, atlas SHA-256 `bf6431f66749f02a616560764af3fdd0adc70b03bca96b2a13b6221bbd847c83`. Three cohorts already sealed under VAL-108/109/110: GSE69138 stroke whole blood n=589, GSE84395 PAH cultured PEC n=39, GSE84274 ascending aorta tissue n=24 (652 samples total). Maximum within-cohort tissue discrimination = 0.0152 vs the pre-locked 0.10 threshold; blood-floor breach on all 5 tiles in GSE69138; gene-promoter A-scores cluster ~0.5 across all heterogeneous β panels regardless of substrate. EpiSCORE HeartRef → atlases_deferred for cardio-epic v0.3.

### Cardio-epic v0.1 → v0.2 promotion (additive structural rebuild)

Cardio-epic v0.2 brings the card from v0.1's 345-line / 23-top-level-key shipping state up to full Block 1-20 + CHK-5.7/5.8/5.9/5.10 structural-parity with breast-epic v2.3 / crc-epic v2.4. The v0.2 rebuild is additive — all v0.1 sealed VAL outcomes are preserved unchanged. New blocks added:

- **CHK-5.7 universal_reference**: 14 substantive sub-keys (universal_stage_1_pipeline, universal_h_min_table all 8 architecture classes, universal_stage_2_moss_deconvolution with healthy_reference_β table for 18 tissues, universal_stage_3_epidish_subcomposition with Salas QC bounds for 7 cell types, universal_80_cell_age_baseline_immune_class for 10 age decades, universal_tier_thresholds for 6 tiers, universal_sex_stratification_rule, universal_language_discipline, universal_cohort_batch_offset_warning, universal_no_fabrication_rule, gape_web_version_reference, plus _purpose / schema_version / last_updated)
- **CHK-5.8 atlases_used_and_deferred**: atlases_run = [Loyfer_25tile, UniLIFE_19cell, Salas_Blood_EPIC_IDOL_6cell] anchored at VAL-108/109/110; atlases_deferred = [EpiSCORE_HeartRef anchored at VAL-111 with full deferral rationale, Caggiano_CelFiE_TIM_cardiac blocked at HM450 manifest acquisition]
- **CHK-5.9 substrate_roadmap**: all 5 EDEAR substrates with status/anchor/target/rationale (DNAm validated v0.2; nucleosome occupancy / fragment fuzziness / WPS / fragment size deferred to v0.4+)
- **CHK-5.10 chk_3_1_thresholds_per_substrate**: BOTH 3.1A and 3.1B per all 4 substrates encountered (TCGA HM450K sesame Level 3 with VAL-106/107 anchors, GenomeStudio AVG_Beta HM450K with VAL-108/110 anchors, minfi preprocessFunnorm HM450K with VAL-109 anchor, GenomeStudio V2011.1 HM450K raw with VAL-110 anchor)
- **lessons_discovered_v0_2**: six discoveries (DISC-CARDIO-001 through DISC-CARDIO-006), six things v0.2 chose not to claim, ten things remaining open
- **LL-CARDIO-005**: atlas-substrate match matters at Stage 2 (atlas-family corollary to LL-CARDIO-001)
- **commercial_deployment_unaffected_by_validation_limitations**: mirrors crc-epic v2.4 structure

### CHK-5.11 atlas-family fitness gate (added 2026-04-29 from LL-CARDIO-005 / VAL-111)

LL-CARDIO-005 formalized that two distinct atlas-scoring modalities exist and they are NOT interchangeable: (a) tile-coverage A-score reading on heterogeneous β panels (Loyfer 25-tile, Caggiano CelFiE TIM); (b) EpiDISH proportion estimation on per-tissue β using gene-promoter integer marker IDs (EpiSCORE family). Cardio-epic Stage 2 needs (a); EpiSCORE HeartRef belongs in (b). VAL-111 sealed the cookbook's first negative atlas-integration result by running EpiSCORE HeartRef in mode (a) when the atlas was designed for mode (b). CHK-5.11 was added to TESTING_CHECKLIST.md to formalize the atlas-family fitness check before sealing any future Stage 2 atlas integration.

### CCL-044 logged in LESSONS_LEARNED.md
...
### Cardio-epic v0.2 deliverables (Heath-only; NOT pushed to GitHub per cookbook IP rule)

- `cardio_epic_card_v0_2.json` — 28 top-level keys, 774 lines, full Block 1-20 + CHK-5.7/5.8/5.9/5.10 structural-parity
- `cardio_epic_README.md` — 397 lines, preserves all v0.1 prose additively, adds VAL-111 + DISC-CARDIO + LL-CARDIO-005 + structural-parity sections
- This v2.4 amendment to README_MASTER
- TESTING_CHECKLIST.md CHK-5.11 addition
- LESSONS_LEARNED.md CCL-044 addition (and LL-CARDIO-005)
- EDEAR_PIPELINE_OFFICIAL_REFERENCE_v2.md Part 19 addition
- GAPE_Reproduction_Paper_v1.md cardio v0.2 status update
- GAPE_Evidence_Report_UPDATED.html cardio v0.2 status update
...
- `Biological_Physics/atlas_vault/stage2_cell_of_origin/episcore_heartref/` (atlas vault: bridged CSV, Entrez matrix, source rda, README, INVENTORY.json entry)
- `Biological_Physics/README.md` — VAL-111 row added in Validation Record table

### EDEAR commercial deployment

VAL-111's deferral of EpiSCORE HeartRef does not affect commercial deployment per CCL-037: cardio-epic v0.2 production scoring uses Loyfer 25-tile (validated) for Stage 2; EpiSCORE HeartRef is not in `atlases_run`. When the v0.3 atlas integration unblocks (re-bridging or Caggiano CelFiE TIM acquisition), the deployment pipeline is updated additively without requiring re-calibration of existing cardio scoring. Cookbook-side documentation gates (CHK-5.7/5.8/5.9/5.10/5.11) are card-publish-time checks, not deployment-time checks.

## v2.4 amendment — Cardio-epic v0.2.1 honesty patch + CCL-045 + CHK-5.12 + DISC-CARDIO-007 (added 2026-04-29 same-day after v0.2 ship)
...
**Issue 1 — atlas naming was incomplete in v0.2.** "Loyfer 25-tile" labeling at 6,105 CpGs misrepresented the canonical Stage 2 reference. The actual atlas in vault is `loyfer_moss_2018/reference_atlas.csv` — 7,890 CpGs across 25 cell-type columns, the **layered Moss + Loyfer array atlas** combined into one file per PIPELINE_REFERENCE Part 2.1+2.2. v0.2.1 corrects this everywhere.

**Issue 2 — atlases_deferred was incomplete in v0.2.** Only 2 deferred atlases listed (EpiSCORE HeartRef + Caggiano CelFiE TIM) when the canonical documents (PIPELINE_REFERENCE Part 2.3–2.7 + TESTING_CHECKLIST §STAGE 0 Queue-1) name several additional cardio-relevant Stage 2 atlases that should have been in atlases_deferred from the start. Most critically: **Konigsberg 2023 cardiovascular 28-cell atlas** (Part 2.4) is named as the cardio deployment blocker with the document-of-record statement *"Without this atlas, cardio-epic cannot be deployed."* v0.2.1 expands atlases_deferred from 2 entries to 8: Konigsberg 2023, Caggiano CelFiE TIM, EpiSCORE Zhu/Teschendorff 2022 pan-tissue, Tanaka 2025 6-cell-type neural, Liu 2023 scMCodes, EpiSCORE HeartRef sub-panel (VAL-111 anchor), MARLIN Capper 2025 training scaffold, Sabedot GeLB 2021.

**Issue 3 — VAL-108/109/110 scored Stage 2 against ONLY the layered Moss+Loyfer combined atlas.** Per the run-everything policy (Heath sign-off 2026-04-26), every IDAT runs Stage 2 against ALL reference atlases in the vault. The other atlases in atlas_vault Stage 2 (caggiano_celfie_2021, caggiano_celfie_tim, episcore_zhu_teschendorff_2022, episcore_heartref pre-VAL-111, marlin_capper_training, sabedot_gelb_2021) were NOT scored. v0.2.1 explicitly acknowledges the run-everything violation and queues corrective re-execution of VAL-108/109/110 against the full atlas stack as part of v0.3 critical path.

### DISC-CARDIO-007 — Always read PIPELINE_REFERENCE Part 2 first

VAL-111 was scored against EpiSCORE HeartRef because that atlas was already in atlas_vault from a prior acquisition pass. PIPELINE_REFERENCE Part 2.4 explicitly names **Konigsberg 2023** — NOT EpiSCORE — as the cardio Stage 2 atlas blocker. None of the canonical-document-named cardio atlases (Konigsberg, Tanaka, Caggiano, EpiSCORE pan-tissue) were prioritized in cardio v0.1/v0.2 because the atlas selection was made by browsing atlas_vault rather than by reading the canonical document. VAL-111 produced a real and useful negative result (atlas-family-fitness lesson, LL-CARDIO-005), but it was a side-track from the canonical cardio atlas critical path.

### CHK-5.12 atlas-canonical-source-check gate (added 2026-04-29 to TESTING_CHECKLIST.md)

Before sealing any new atlas integration prereg, the prereg must cite which canonical-document section names the atlas as a production candidate for the card under test. Companion to CHK-5.11 atlas-family-fitness check. Together CHK-5.11 + CHK-5.12 form the "is this the right atlas to test?" gate before any atlas integration VAL is sealed.

### CCL-045 logged in LESSONS_LEARNED.md

CCL-045 — Cardio-epic v0.2.1 same-day honesty patch: atlas naming corrected, atlases_deferred expanded to canonical-document-named full list, DISC-CARDIO-007 added, run-everything violation in VAL-108/109/110 acknowledged. Generalizes to every card: atlas selection by "browsing atlas_vault" is not sufficient — the canonical-document anchor is mandatory in every atlas integration prereg via CHK-5.12.

### v0.3 critical path for cardio-epic deployment

Documented in cardio-epic v0.2.1 card JSON `canonical_documents_named_blocker_for_cardio_deployment` block. Phase A: acquire Konigsberg 2023 (highest priority). Phase A: acquire HM450 hg19 manifest to unblock Caggiano CelFiE TIM. Phase A: engineer Tanaka 2025 nanopore→array CpG bridge. Phase A: integrate EpiSCORE pan-tissue via R rpy2 bridge. Phase B: per-atlas calibration VAL on structurally-separated healthy cohort BEFORE cardio-cohort scoring. Phase C: cardio-cohort scoring VAL against each calibrated atlas + re-execute VAL-108/109/110 on full atlas stack. Phase D: cardio-epic v0.3 ship.

### Cardio-epic v0.2.1 deliverables (Heath-only; NOT pushed to GitHub per cookbook IP rule)

- `cardio_epic_card_v0_2_1.json` — 29 top-level keys, 863 lines, full Block 1-20 + CHK-5.7/5.8/5.9/5.10/5.11/5.12 structural-parity, atlases_deferred expanded to 8 entries, canonical_documents_named_blocker_for_cardio_deployment block added, DISC-CARDIO-007 added
- `cardio_epic_README_v0_2_1.md` — 456 lines, preserves all v0.2 prose, adds DISC-CARDIO-007, atlas naming corrections, v0.2 → v0.2.1 changes section, v0.3 critical path detail
- This v2.4 amendment to README_MASTER
- TESTING_CHECKLIST.md CHK-5.12 addition
- LESSONS_LEARNED.md CCL-045 addition
- EDEAR_PIPELINE_OFFICIAL_REFERENCE_v2.md Part 20 addition
- GAPE_Reproduction_Paper_v1.md §7.22 addition
- GAPE_Evidence_Report_UPDATED.html v0.2.1 honesty-patch section

### No additional GitHub-side artifacts in v0.2.1

VAL-111 directory + EpiSCORE HeartRef atlas vault + Biological_Physics/README.md row remain at commit `facbe7a` (2026-04-29 morning). v0.2.1 is a cookbook-IP-side patch only.
...
## v2.4 amendment — Cardio-epic v0.2.2 second-honesty-patch + CCL-046 + CHK-5.13 (added 2026-04-29 same-day afternoon, on top of the morning v0.2.1 patch)

After cardio-epic v0.2.1 shipped 2026-04-29 morning, Phase A acquisition began for the canonical-document-named "Konigsberg 2023" cardio Stage 2 atlas per v0.2.1's revised critical path. Web verification of the cited DOI (`10.1093/nargab/lqad061`) found that the canonical document had two factual errors:

**Error 1 — author attribution wrong.** The actual paper at the cited DOI is **Cuadrat, Kratzer, Giral Arnal et al. 2023** (*NAR Genomics and Bioinformatics* 5(2):lqad061). No "Konigsberg" appears in the author list. A second targeted search for any Konigsberg-authored cardiovascular methylation atlas paper returned zero hits — the citation was either misremembered or conflated with a different paper.

**Error 2 — cell-type content wrong.** The canonical document claimed the atlas was a "28-cell-type extended atlas including sorted cardiomyocytes, cardiac fibroblasts, vascular endothelial, smooth muscle." The actual Cuadrat 2023 atlas is the **Moss 2018 25-tissue base extended with three bulk ENCODE EPIC heart tissues**: right atrium auricular (n=2 ENCODE accessions), heart left ventricle (n=2), coronary artery (n=2). 28 total tissues by adding three bulk heart regions to the Moss 25-tissue base, NOT 28 sorted cell types. The "sorted cardiomyocytes" claim is not in the paper at all.

### CCL-046 LL-CANONICAL-DOC-FACTUAL-ERROR — Documents-of-record can contain factual errors

DISC-CARDIO-007 + CHK-5.12 (added in v0.2.1) protected against picking the wrong atlas from atlas_vault by forcing atlas selection to trace to the canonical document. But CHK-5.12 does not protect against following an incorrect citation in the canonical document itself. The Part 2.4 error sat undetected through cardio-epic v0.1 + v0.2 + v0.2.1 (three card versions) and only surfaced when CHK-5.12 forced the Phase A acquisition attempt. The second-order error — that the document of record contained a factual error — required a separate gate.

### CHK-5.13 documents-of-record citation-verification gate (added 2026-04-29 to TESTING_CHECKLIST.md)

Companion to CHK-5.11 atlas-family-fitness and CHK-5.12 atlas-canonical-source-check. Before sealing a card publish or a card promotion (v0.X → v0.X+1), every external citation introduced in the new card content (canonical-document quotes, atlas attributions, cohort accessions, prior-art references in deferral rationales) must have at least one web-verification pass: the DOI loads, the authors match the citation, the described content matches the abstract/methods/figures of the actual paper, every cohort accession resolves to an actual deposit. Cheap (one web search per citation) and catches an entire class of compounding errors.

### "Cannot be deployed" framing dropped per Q2(B)

The v0.2.1 deployment story said *"Without this atlas, cardio-epic cannot be deployed"* — anchored on a fictional sorted-cardiomyocyte atlas. With the anchor gone, the honest cardio-epic deployment story reads: cardio-epic is operational at v0.2 under the layered Moss+Loyfer atlas with Stage 1 immune as the validated workhorse (VAL-110 d=+1.08 normal vs BAV on aortic tissue). Cuadrat 2023 + Caggiano CelFiE TIM + EpiSCORE pan-tissue + Tanaka 2025 are integration enhancements that broaden cardio Stage 2 cell-of-origin coverage at bulk-heart-tissue resolution but do not gate deployment.

### Sorted-cardiomyocyte array-CpG atlas — open published-literature gap acknowledged

As of 2026-04-29 no such atlas exists at array-CpG resolution. Published cardiac methylation work covers either targeted CpG biomarkers (Zemmour 2018 FAM101A; Yamazoe 2021 mt-cfDNA), bulk heart tissues (Moss 2018 Left_atrium; Cuadrat 2023 right atrium + left ventricle + coronary artery), or sorted vascular cells (Loyfer 2023 vascular_endothelial + smooth_muscle as part of the layered atlas already in production). Sorted cardiomyocyte at array-CpG resolution is an open gap. When published, it becomes a v1.0+ candidate. Cookbook surveillance pass for this atlas added to the monthly atlas-surveillance routine.

### v0.3 critical path revised after Cuadrat correction

Cuadrat 2023 (the actual paper) replaces the fictional Konigsberg 2023 in v0.3 Phase A priority. Acquisition path is straightforward: open access CC-BY paper, MIT-licensed R package `deconvR`, signature matrix in supplementary data, six publicly available ENCODE EPIC IDAT accessions. Phase A revised order: Cuadrat 2023 first, Caggiano CelFiE TIM cardiac second, Tanaka 2025 third, EpiSCORE pan-tissue fourth.

### PIPELINE_REFERENCE Part 2.4 fully rewritten

Replaced with corrected Cuadrat 2023 description + correction note + sorted-cardiomyocyte gap acknowledgment. Part 21 added documenting the v0.2.2 honesty patch and CCL-046 documents-of-record audit lesson.

### Cardio-epic v0.2.2 deliverables (Heath-only; NOT pushed to GitHub per cookbook IP rule)

- `cardio_epic_card_v0_2_2.json` — 29 top-level keys, 881 lines. atlases_deferred Konigsberg entry replaced with Cuadrat 2023; new Sorted_cardiomyocyte_array_CpG_atlas_OPEN_GAP entry added (target v1.0+); old canonical_documents_named_blocker_for_cardio_deployment block replaced with new canonical_documents_cardio_stage2_extension_path block (drops cannot-be-deployed framing; acknowledges sorted-cardiomyocyte gap; revised v0.3 priority order).
- `cardio_epic_README_v0_2_2.md` — 473 lines, preserves all v0.2.1 prose, corrects DISC-CARDIO-007 prose to reference Cuadrat finding, replaces atlases_deferred Konigsberg row with Cuadrat row + sorted-cardiomyocyte-gap row, replaces canonical-document-named-blocker prose with corrected Cuadrat framing, adds v0.2.1 → v0.2.2 changes section, revises v0.3 critical path.
- This v2.4 amendment to README_MASTER
- TESTING_CHECKLIST.md CHK-5.13 addition
- LESSONS_LEARNED.md CCL-046 addition
- EDEAR_PIPELINE_OFFICIAL_REFERENCE_v2.md Part 2.4 rewrite + Part 21 addition
- GAPE_Reproduction_Paper_v1.md §7.23 addition
- GAPE_Evidence_Report_UPDATED.html v0.2.2 honesty-patch section

### No additional GitHub-side artifacts in v0.2.2

VAL-111 directory + EpiSCORE HeartRef atlas vault + Biological_Physics/README.md row remain at commit `facbe7a` (2026-04-29 morning). v0.2.2 is a cookbook-IP-side patch only.
...
## v2.4 amendment continuation — Cardio-epic v0.2.2 expansion: DISC-CARDIO-008 + CCL-047 atlas dedupe + CCL-046 citation audit pass + four broken Evidence Report figures fixed (added 2026-04-29 same-day after v0.2.2 initial patch)

After the initial v0.2.2 patch shipped (Cuadrat correction + CHK-5.13 + sorted-cardiomyocyte gap acknowledgment), three follow-on items completed the v0.2.2 cycle:

### CCL-047 atlas-deduplication finding + DISC-CARDIO-008 + CHK-3.1C atlas-deduplication gate

Phase A acquisition for the Cuadrat 2023 atlas began per v0.2.2 corrected critical path. Acquired the deconvR Bioconductor package (`deconvR_1.16.0.tar.gz`, 3.98 MB) which bundles the canonical Moss 2018 base atlas as `HumanCellTypeMethAtlas.rda`. Comparing it to the cookbook's `loyfer_moss_2018/reference_atlas.csv` revealed: cookbook file has **7,890 rows but only 6,105 unique CpG IDs** (1,785 duplicate rows — 1,270 CpGs duplicated 2-8× each, 4,835 CpGs unique). Same 25 cell-type columns. Intersection with deconvR atlas = exactly 6,105, zero unique either direction. The cookbook file is the un-deduped Moss 2018 base; deconvR distributes the deduped version.

**Mechanical impact (val_108.py Stage 2 scoring):** lines 124-132 compute per-tile A-scores via `(sample_β - tile_ref_β).abs().mean()` over the intersection of `sample_b.index` with `loyfer_df.index`; pandas `loc` on an Index with duplicates retains all matching rows. Identical-value duplicates therefore reweight CpG contributions to the per-tile mean. The duplicated CpGs in the cookbook file are systematically lower-β (~0.42-0.43 mean across the 25 tile columns) than the non-duplicated CpGs (~0.50-0.52 mean), so leaving duplicates in produces a uniform −0.017 to −0.025 bias on per-tile reference β across all 25 tile columns.

**Sealed-outcome impact:** Synthetic-patient test (β=0.5 everywhere): A-score difference between buggy and deduped scoring is +0.003 to +0.024 per tile, **uniform across all patients regardless of disease state**. Within-cohort Cohen's d (case mean - control mean over per-patient A-scores) is unbiased to this effect because the bias hits both case and control means equivalently and cancels in the difference. Sealed cardio findings — VAL-110 d=+1.08 normal vs BAV (Stage 1 immune workhorse), VAL-109 d=+0.79 control vs hPAH on EC tile, VAL-108 max |d|=0.167 stroke etiology nulls, VAL-111 EpiSCORE HeartRef tile floor — are robust to this bias. Absolute A-score magnitudes are biased by ~0.003-0.024 per tile in the sealed VAL outputs.
...
**CHK-3.1C atlas-deduplication gate (added 2026-04-29 to TESTING_CHECKLIST.md).** Companion to CHK-3.1A (substrate gate) and CHK-3.1B (panel-coverage gate). Before any new atlas integration calibration VAL is sealed, the prereg confirms the atlas file in atlas_vault has zero duplicate CpG IDs (`pd.read_csv(...).index.duplicated().any() == False`). Cheap one-line check, prevents cooked-in calibration bias. Generalizes to every reference matrix in atlas_vault — Stage 3 immune atlases (UniLIFE, Salas IDOL, EpiSCORE pan-tissue, Caggiano CelFiE TIM, MARLIN, Sabedot) all need duplicate-CpG checks at integration. v0.3 cookbook engineering task: add a structural-validation script that walks every atlas in atlas_vault and reports duplicate-CpG counts, β-value ranges, missing-value counts, tile-column consistency. Output goes to `atlas_vault/INVENTORY.json`.

### CCL-046 audit pass — citation verification status (CHK-5.13 first application)

CHK-5.13 documents-of-record citation-verification gate was applied to the v0.2.2 patch work. Of 12 unique DOIs touched in v0.2/v0.2.1/v0.2.2 patch documentation:

**Verified accurate (8/12)**: Cuadrat 2023 (`10.1093/nargab/lqad061`); Loyfer 2023 Nature (`10.1038/s41586-022-05580-6`); Xu/Sandler/Taylor 2020 JNCI (`10.1093/jnci/djz065`); Moss 2018 Nat Commun (`10.1038/s41467-018-07466-6`); Zhu et al. 2022 EpiSCORE Nat Methods (`10.1038/s41592-022-01412-7`); Zemmour 2018 FAM101A Nat Commun (`10.1038/s41467-018-03961-y`); Yamazoe 2021 mt-cfDNA Sci Rep (`10.1038/s41598-021-85204-7`); Salas IDOL base 2018 Genome Biology (`10.1186/s13059-018-1448-7`).
...
**Pre-existing Evidence Report citations (130 DOIs) NOT verified in v0.2.2 patch.** Inherited from prior card versions and earlier cookbook content. Per CCL-046, the broader citation audit is a v0.3 cookbook engineering task — Python script that walks .md files, extracts DOIs, web-verifies attributions against a manifest. Manual CHK-5.13 verification per-card-publish remains the immediate gate for new content.

**Validation of CHK-5.13.** The audit pass that found Liu→Tian and Caggiano DOI errors validates CHK-5.13's value — the gate caught two real errors on its first application, on top of the Konigsberg→Cuadrat finding that motivated its creation. Three errors of the same class found across PIPELINE_REFERENCE Parts 2.4, 2.5/2.6, and 2.7 / LESSONS_LEARNED CCL-001 suggests the broader audit is going to find more.

### Four broken Evidence Report figures replaced with placeholders

Four `<img src="figures/...">` references near the end of GAPE_Evidence_Report_UPDATED.html (fig1_loud_at_distance, fig2_two_cohort_breast, fig3_colorectal_subtypes, fig4_percentile_rank) referenced PNG files in a `figures/` subdirectory not bundled in the standalone HTML — rendered as white-square broken-image artifacts with question marks. PNG sources not present in mounted volumes (only IAM-physics figures available, different project). Replaced each broken `<img>` with a styled `<div>` placeholder reading "[Figure N asset not bundled in standalone HTML — see caption below]", preserving all four figure captions intact (the captions describe each figure in detail). v0.3 task: regenerate figure PNGs and re-bundle for the next Evidence Report release.

### v0.2.2 expansion artifacts (Heath-only; NOT pushed to GitHub per cookbook IP rule)

Same delivery folder `heath_only_v2026_04_29_v0_2_2_patch/`. Files updated in expansion:

- `cardio_epic_card_v0_2_2.json` — DISC-CARDIO-008 added (888 lines, was 881)
- `cardio_epic_README_v0_2_2.md` — DISC-CARDIO-008 prose added, v0.2.2 changes section expanded (485 lines, was 473)
- `TESTING_CHECKLIST.md` — CHK-3.1C atlas-deduplication gate added (609 lines, was 587)
- `LESSONS_LEARNED.md` — CCL-047 + CCL-046 audit-pass status logged + Caggiano DOI corrected (1311 lines, was 1274)
- `README_MASTER_v2_4.md` — this v2.4 amendment continuation
- `GAPE_Evidence_Report_UPDATED.html` — four broken `<img>` tags replaced with styled placeholder divs (18165 lines unchanged)

EDEAR_PIPELINE_OFFICIAL_REFERENCE_v2.md and GAPE_Reproduction_Paper_v1.md not modified in this expansion — the v0.2.2 expansion content is logged in LESSONS_LEARNED, README_MASTER, TESTING_CHECKLIST, and the cardio-epic card/README per per-card workflow discipline.
...
## v2.5 amendment — VAL-112 + VAL-113 cardio run-everything sprint + CCL-047 dedupe + CCL-048 substrate-normalization-required (added 2026-04-29 evening, after the v0.2.2 morning + afternoon honesty patches)

After v0.2.2 honesty patches were shipped 2026-04-29, Heath flagged that cardio-epic v0.2.x had not honored the run-everything architecture signed off 2026-04-26. VAL-108/109/110 scored Stage 2 against a single un-deduped atlas (layered Moss+Loyfer); VAL-111 scored Stage 2 against a different single atlas (EpiSCORE HeartRef sub-panel); neither was atlas-specific calibrated on a structurally-separated healthy cohort per CCL-041. VAL-112 + VAL-113 corrects this for cardio-epic v0.3.

### Phase A engineering completed

- Layered Moss+Loyfer reference_atlas.csv deduplicated: 7,890 rows → 6,105 unique CpGs (1,785 identical-value duplicate rows removed). Original preserved as `reference_atlas_v0.2_with_duplicates.csv` for audit-trail. CCL-047 LL-ATLAS-DEDUPE logged. CHK-3.1C atlas-deduplication gate added to TESTING_CHECKLIST.md.
- Caggiano CelFiE TIM array-bridged atlas built: 1,581 WGBS regions → 254 unique array CpGs × 19 cell types via HM450 hg19 manifest CpG-in-region intersection. Multi-region CpGs averaged. CHK-3.1C passed. New canonical at `atlas_vault/stage2_cell_of_origin/caggiano_celfie_tim/caggiano_tim_cpg_bridged.csv`.
- HM450 hg19 manifest extracted from Bioconductor IlluminaHumanMethylation450kanno v0.6.1 via direct R slot access (485,512 CpGs × chr × pos). Reusable for any region-indexed WGBS atlas bridge to array CpGs.

### Phase B calibration (CCL-041 discipline) on TCGA HM450 sesame Level 3 n=210

Same calibration cohort as VAL-106/107 (TCGA-KIRC n=160 + TCGA-PRAD n=50 adjacent-normal). Three atlases calibrated:
...
Per-tile healthy-floor A-score distributions sealed for every tile of every atlas. Calibration JSONs at `validation_runs/VAL-112_run_everything/VAL-112_calibration_results.json` + `validation_runs/VAL-113_caggiano/VAL-113_calibration_results.json`.

### Phase C run-everything execution

All three atlases scored against all three cardio cohorts: GSE69138 stroke etiology (n=589), GSE84395 PAH variants (n=39), GSE84274 ascending aortic (n=24). Per-sample CSVs + Cohen's d per atlas per tile per group-pair sealed at `validation_runs/VAL-112_113_unified/`.

### Findings under run-everything

**PAH (GSE84395) — convergent strong cardiac signal across 3 atlases.** Caggiano `heart` = +1.42 (control vs iPAH); HeartRef `CM` = −0.80; Loyfer `Vascular_endothelial_cells` = +0.83. Three independent atlases, three convergent positive findings. PAH detection is the most robust cardio application validated.

**BAV/dissection (GSE84274) — multi-atlas exposes Loyfer's small-n confounders.** Loyfer normal_vs_BAV |d| > 2 on Colon_epithelial / Hepatocytes / Pancreatic was a small-n confounder (n=6 vs 6). Cardiac-specialized atlases (Caggiano `heart` = +1.40, `endothelial` = +1.52; HeartRef `CM` = −0.60) showed clean cardiac signal without spurious tissue noise. Multi-atlas triangulation catches single-atlas artifacts. Mandate multi-atlas reporting for v0.3 cardio scoring.

**Stroke etiology (GSE69138) — convergent null across 3 atlases.** All three atlases agree max |d| = 0.19. Three different reference panels arriving at the same null is much stronger than VAL-108's single-atlas null. Confirms VAL-108 sealed null finding.

### CCL-048 LL-SUBSTRATE-NORMALIZATION-REQUIRED — formalized 2026-04-29
...
- TCGA HM450 sesame Level 3 is the cookbook reference substrate (calibrated by VAL-106/107/112/113).
- Production deployment requires customer's IDAT files to go through sesame normalization (recommended path: `deconvR` or `sesameData` R packages) OR customer-specific calibration VAL on within-cohort self-cal substrate.
- CHK-0.7 substrate-normalization-required gate added to TESTING_CHECKLIST.md.
- Part 22 substrate normalization pipeline architecture added to EDEAR_PIPELINE_OFFICIAL_REFERENCE_v2.md.
- §7.24 added to GAPE_Reproduction_Paper_v1.md.

### EDEAR commercial deployment (CCL-037 unaffected)

CCL-037 production deployment runs single calibrated patient-vs-internal-reference pipeline, structurally insulated from public-cohort substrate diversity. CCL-048 + CHK-0.7 add the explicit gate that substrate must be calibrated before scoring, with sesame Level 3 as the reference path. Customer onboarding includes a one-time substrate-normalization-and-calibration step per customer (full sequence in PIPELINE_REFERENCE Part 22).

### v0.3 cardio-epic ship readiness

Stage 2 atlas stack: layered Moss+Loyfer (deduped) + EpiSCORE HeartRef bridged + Caggiano TIM array-bridged. All three calibrated on TCGA n=210; all three CHK-3.1A/B/C passed. Cardio-epic v0.3 has the calibrated, deduplicated, multi-atlas, run-everything-disciplined Phase B + C results that v0.2.x was missing. v0.2.x sealed VAL outcomes preserved unchanged in audit-trail.

### Cross-card audit task — v0.3+

The other cards (breast-epic, crc-epic, AD-immune, lung-epic, hcc-epic, kidney-epic, cervical-epic, glioma-epic) need a substrate-calibration audit at v0.3+ to determine which atlases have proper VAL-112/113-style structurally-separated calibration vs which run on within-cohort self-cal. Not blocking commercial deployment per CCL-037; required for cookbook-side claim-quality.

### GitHub state

Commit 57beb38 pushed 2026-04-29 to `hmahaffeyges/IAM-Validation`:
- Atlas vault updated: deduped Loyfer canonical, Caggiano TIM bridged canonical, INVENTORY.json updated with calibration anchors
- VAL-112 + VAL-113 + VAL-112_113_unified directories with all calibration JSONs, per-cohort per-sample CSVs, Cohen's d JSONs, code, outcome.md
- Original Loyfer 7,890-row file preserved as audit-trail

---

## v2.5 amendment — Prostate-epic v0.2 → v0.3 multi_modal_validated_plus_multi_atlas_calibrated promotion (added 2026-04-30)

### Sprint summary

Prostate-epic promoted from `stage_2_only_validated` (v0.2 anchor: VAL-058 Xu-538 Stage 1 immune panel on GSE269244 tumor tissue, paired d = +0.497) to `multi_modal_validated_plus_multi_atlas_calibrated` (v0.3) via the same VAL-112/113-style calibration discipline that anchored cardio-epic v0.3.

**Phase B calibration anchor — VAL-117.** EpiSCORE ProstateRef gene-promoter atlas CpG-bridged to 2,603 unique 450K CpGs across six prostate cell types (BE basal epithelial, EC vascular endothelial, Fib fibroblast, LE luminal epithelial, Leu intra-prostatic leukocyte, SM smooth muscle) via the EpiSCORE-provided `probeInfo450k.lv` Entrez→450K-CpG manifest (159 of 163 ProstateRef Entrez IDs covered; 4 IDs without 450K CpGs in the manifest dropped). Bridged atlas SHA-256: `4e60c3d038a637e9742f51d9bc7c119e06fe5d2e91abb2b12db8867ceb7813d2` (zero duplicate probeIDs after CHK-3.1C deduplication). Calibrated on TCGA-KIRC + TCGA-PRAD adjacent-normal n=210 sesame Level 3 substrate (the same calibration cohort that anchored cardio VAL-106/107/112/113). All three CHK gates clear: CHK-3.1A 206/210 (98.1%), CHK-3.1B 210/210 (100% under amended ≥80% threshold per TCGA HM450K substrate floor — original prereg's 95% spec was a CCL-041 spec error caught and amended sealed BEFORE re-execution per CCL-041 audit-trail discipline), CHK-3.1C 0 duplicates. Per-tile healthy-floor distributions sealed (LE tightest: mean 0.4254, sd 0.0041, q5 0.4190, range 0.0293; Leu widest: range 0.0597, well above 0.02 tissue-floor-dominated threshold). VAL-117 sealed `O1_PROSTATEREF_CALIBRATION_SEALED`. ProstateRef does NOT collapse to tissue-floor-dominated like cardio HeartRef did at VAL-111.

**Phase C run-everything multi-atlas re-scoring — VAL-118.** GSE269244 (n=238 EPIC 850K FFPE prostate, AA men, 118 paired patients) scored against five atlases under run-everything discipline: Xu-538 Stage 1 reproduction control + ProstateRef + Layered Moss+Loyfer 17-tile subset + UniLIFE 19-cell + Salas Blood.EPIC IDOL Stage 3. Two-stage architecture (streaming Stage 1 atlas-CpG extraction in 54 sec + vectorized numpy Stage 2 scoring in 2 sec). β matrix SHA-256 `7b9fa2825bdd88b0936afba0e19fb0fbcf1bd404a65469d9fb0735829dc88a89` (bit-for-bit identical to VAL-058 sealed).

Stage 1 Xu-538 reproduction control: paired d = +0.5258 vs VAL-058 sealed +0.4973 (Δ +0.029, within ±0.10 tolerance). Stage 1 anchor stands.

ProstateRef per-tile signature (118 paired tumor + adjacent-normal):

| Tile | Class | d_paired | d_unpaired | Direction |
|---|---|---|---|---|
| LE (luminal epithelial — PCa cell of origin) | secretory | **−0.767** | −0.695 | LE_NEGATIVE — luminal dedifferentiation |
| BE (basal epithelial) | secretory | +0.477 | +0.440 | BE_POSITIVE |
| EC (vascular endothelial) | stromal | +1.284 | +1.682 | EC_POSITIVE |
| Fib (fibroblasts) | stromal | +1.311 | +1.621 | Fib_POSITIVE |
| Leu (intra-prostatic leukocytes) | immune | +0.999 | +1.149 | Leu_POSITIVE |
| SM (smooth muscle, peri-prostatic) | stromal | +1.092 | +1.350 | SM_POSITIVE |

The five-vs-one direction split is the v0.3 prostate cancer methylation-architecture signature: tumor cell of origin loses canonical luminal methylation (LE A-score falls because tumor cells move AWAY from healthy reference) while tumor microenvironment (vascular, fibroblast, peri-prostatic smooth muscle, intra-prostatic immune) develops architectural complexity that doesn't fit healthy references (those A-scores rise). Stage 3 multi-atlas immune signature: Salas IDOL Mono d_paired = +0.771; Bcell +0.674; CD4T +0.659; NK +0.645; CD8T +0.587 — five tiles between +0.59 and +0.77 (broad TIL infiltration consistent with Berglund 2024 published CD40/OX40L/STING DMRs). UniLIFE 19-cell confirms at lower magnitudes (aMono +0.467; aNeu +0.433).

### CCL-041 amendment audit trail

VAL-118 first execution sealed `O5_LE_DIRECTION_FLIP_UNANTICIPATED` (preserved as discipline-discovery record at GitHub commit `edf6229`) because the original prereg pre-locked O2 as `LE paired d ≥ +0.30` (positive direction only). Observed pattern was clean strong negative (−0.767). CCL-041 forbade post-hoc sign-flip. Per Heath sign-off (option 1 of three post-first-execution paths — re-prereg with corrected magnitude-based threshold + re-execute), an amendment changed the threshold to magnitude-based `|d_paired| ≥ 0.30` with direction labels (LE_POSITIVE / LE_NEGATIVE), sealed BEFORE re-execution. Re-execution sealed `O1_MULTI_ATLAS_CONVERGENT + O2_LE_TILE_DIFFERENTIATING (LE_NEGATIVE) + O4_STAGE_3_IMMUNE_SHIFT_PROMINENT` cleanly. Both outcomes preserved in GitHub audit trail (`outcome.md` for first execution; `outcome_amendment.md` for the re-execution that supersedes for v0.3 card promotion purposes).

The amendment is documented as a SPEC-error correction, not threshold relaxation: the original prereg's direction-locked threshold was inadvertent over-specification (cookbook-wide default per CCL-041 going forward is magnitude-based |d| with direction labels for cell-of-origin atlas tiles where biology supports direction-ambiguity).

### DISC-PROSTATE discoveries sealed (propagate to LESSONS_LEARNED.md)

- **DISC-PROSTATE-001** — Gene-promoter atlas family fitness depends on per-tissue cell-type distinctness (extends DISC-CARDIO-004 / LL-CARDIO-005). ProstateRef separates cleanly on prostate biology where HeartRef collapsed on cardiac biology because cardiac cell types share substantial gene-promoter methylation similarity.
- **DISC-PROSTATE-002** — Pre-registration discipline must use magnitude-based |d| thresholds with direction labels for cell-of-origin atlas preregs where biology supports direction-ambiguity. Cookbook-wide rule formalized as **CHK-2.7** in TESTING_CHECKLIST.md.
- **DISC-PROSTATE-003** — ProstateRef LE tile reads tumor strongly NEGATIVE (luminal dedifferentiation signature). A_LE BELOW VAL-117 healthy-floor q5 = 0.4190 is the operational diagnostic for v0.3 tissue-substrate disease scoring + post-treatment trajectory monitoring.

### CHK gates added to TESTING_CHECKLIST.md

- **CHK-2.7** Cell-of-origin atlas preregs MUST use magnitude-based |d| thresholds with direction labels (per DISC-PROSTATE-002).
- **CHK-2.8** CHK-3.1B coverage threshold pre-locks must match substrate floor, NOT default 95% (per VAL-117 amendment). TCGA HM450K sesame Level 3 floor is ~80%, NOT 95% — TCGA's QC pipeline routinely drops 12-20% of probes via cross-reactive masking, SNP-overlap, and detection p-value failures.

### Atlas vault state

ProstateRef CpG-bridged matrix added to `Biological_Physics/atlas_vault/stage2_cell_of_origin/episcore_prostateref/` as the third successful EpiSCORE bridge alongside HeartRef (cardio sprint, sealed VAL-111 with O3_TISSUE_FLOOR_DOMINATED) and BreastRef. INVENTORY.json updated with VAL-117 calibration anchor.

### v0.2 limitations preserved unchanged

Pre-diagnostic blood screening (FitzGerald 2017 MCCS pre-dx + Howard AA EPIC remain v1.0+ next-validation-steps, both biobank-gated); multi-ancestry generalizability (anchor cohorts 100% AA men); Gleason aggressiveness stratification (descriptive-only stratified-results JSON shows LE-negative pattern across all three Gleason grade groups but is NOT a v0.3 claim — aggressiveness card extension deferred to v0.4); early-stage localized plasma ccfDNA detection underpowered; urine substrate clinical pathway VAL-065 n=4 ceiling (CCL-026 open question unchanged); Layered Moss+Loyfer Prostate_epithelial bulk-tile differentiation deferred to v0.4 (atlas vault layered file scores 17-tile subset that excludes the bulk Prostate_epithelial column at this time).

### GitHub state

Commit chain on `hmahaffeyges/IAM-Validation`:
- `40ce175` — VAL-117 ProstateRef Phase B calibration anchor (Python script, prereg + amendment, results JSON, per-sample CSV, outcome.md, seal files)
- `edf6229` — VAL-118 first execution sealed O5 (val118_stage1_extract.py, val118_stage2_score.py, prereg.md, results JSON, per-sample CSV, outcome.md, PREREG_SEAL.txt) — preserved as discipline-discovery record
- `58ecd16` — VAL-118 amendment sealed O1+O2(LE_NEGATIVE)+O4 (prereg_amendment.md, amendment results JSON, amendment per-sample CSV, outcome_amendment.md, PREREG_AMENDMENT_SEAL.txt)
- `c5ee9d5` — Phase D v0.2-vs-v0.3 outcome comparison (`phase_d_v02_vs_v03.md`)
- `388e5b0` — F.1 deliverables: VAL-118_cohort_manifest.json (238 samples, 118 paired, β SHA verified), VAL-118_clinical_metadata.json (de-identified, stratification variables enumerated, P-4585-T data quirk documented), VAL-118_stratified_results.json (Gleason grade group breakdown — descriptive only, NOT a v0.3 claim), Biological_Physics/README.md update (315 → 317 lines, prostate-epic v0.3 update paragraph at top of update history)

EDEAR commercial deployment unaffected per CCL-037 throughout.



---

## 2026-05-01 — bladder-epic v0.1 ship (added 2026-05-01 PM)

Bladder-epic ships at v0.1 with four sealed VALs and four DISC discoveries. The sprint structure ran end-to-end in 36 hours of session time: Phase 0 cohort survey signed off 2026-04-30 → Phase A bridge engineering of EpiSCORE BladderRef (2,696 unique 450K CpGs × 4 cell types) → Phase B calibration on TCGA-KIRC + TCGA-PRAD adjacent-normal n=210 (sealed VAL-119 at O1) → Phase C run-everything Phase C scoring on TCGA-BLCA n=440 (sealed VAL-120 at O4 / VAL-121 at O2_DIRECTION_AMBIGUOUS / VAL-122 at O1_IMMUNE_DIFFERENTIATING).

### What bladder-epic v0.1 ships

The card line under no-overclaim language: "Phase C scoring on TCGA-BLCA n=440 (HM450K sesame Level 3, 21 paired tumor-vs-adjacent-normal patients) produced results consistent with the framework and with published bladder cancer biology. Stage 1 immune red flag fires diagnostically at d_paired=+1.90, p=3.1×10⁻⁸, but Xu-538 panel cohort-substrate coverage triggered O4 sealed outcome (DISC-BLADDER-004). Stage 2 cell-of-origin: BladderRef Epi paired d=−1.46 (p=1.6×10⁻⁶) satisfies CCL-039 expectation; Loyfer bulk Bladder fires opposite direction reflecting substrate-distribution mismatch on mucosal cohort (DISC-BLADDER-003). Stage 3 immune fine-tune fires across all 6 Salas IDOL tiles consistent with mixed TIL+TAM+MDSC infiltration of muscle-invasive bladder tumor microenvironment."

### Why this sprint matters to the cookbook

Bladder is the **first mucosal-tissue card** the cookbook has shipped. All prior cards (cardio, prostate, breast, lung, ad-immune, hcc, crc, kidney, cervical) used solid-parenchyma cohorts or culture-derived cohorts — and those used the VAL-106 0.50/0.12 CHK-3.1A floor that was implicitly assumed cookbook-wide. Bladder-epic v0.1 surfaced that the floor is tissue-class-dependent, not universal — and the cookbook caught its own assumption mid-sprint via prereg discipline (β data observed before amendment; honest CCL-041 second-best-path disclosure on amendment 002). **The sprint is the reference example for how the cookbook self-corrects when a silent assumption meets data that violates it.**

The four DISC-BLADDER discoveries each strengthen the cookbook for every future card:

- **DISC-BLADDER-001** confirms the gene-promoter atlas family fitness rule extends across cardio (failed) + prostate (succeeded) + bladder (succeeded). Cell-type DISTINCTNESS is the discriminating variable, not COUNT. Future EpiSCORE per-tissue bridges (LungRef, ColonRef, etc.) get prioritized by per-tissue calibration smoke test, not by source matrix dimensions.
- **DISC-BLADDER-002** parameterizes CHK-3.1A by tissue class. Solid parenchyma class (existing): 0.50/0.12. Mucosal class (new): 0.387/0.184. Cultured-cell class: cohort-internal. CHK-2.16 added to TESTING_CHECKLIST.
- **DISC-BLADDER-003** establishes the mucosal-tissue rule: bulk-WGBS atlases on mucosal-cohort substrates produce inflated cross-tile A-scores; gene-promoter sub-cell-type atlases must be the primary cell-of-origin reader on mucosal cohorts. This generalizes — every future mucosal card (lung-epic, crc-epic, future cervical-epic, future GI cards) needs a gene-promoter atlas in its `atlases_run`.
- **DISC-BLADDER-004** establishes the panel-validation rule: Stage 1 panel transferability is cohort-specific, not platform-specific. CHK-2.17 added to TESTING_CHECKLIST. VAL-114 Wave 1 calibration protocol gets the cohort-substrate precheck baked in.

### Atlas vault state

EpiSCORE BladderRef CpG-bridged matrix added to `Biological_Physics/atlas_vault/stage2_cell_of_origin/episcore_bladderref/` as the fourth successful EpiSCORE bridge alongside HeartRef (cardio sprint, sealed VAL-111 with O3_TISSUE_FLOOR_DOMINATED) + BreastRef (sealed VAL-094) + ProstateRef (prostate sprint, sealed VAL-117). INVENTORY.json updated 90 → 94 entries with VAL-119 calibration anchor.

Atlas SHA-256 (canonical, anchored): `3005663b4ede4b20199bacff641952390b1434764b8cf0915cdc9d6a6c1517c6`

### v0.1 limitations preserved unchanged for v0.2 promotion path

Stage 1 panel-cohort transferability (Xu-538 → bladder-cohort-validated panel via VAL-114 Wave 1 + CHK-2.17 precheck); Stage 2 mucosal-aware A-score normalization (substrate-distribution-aware research to make Loyfer readings useful on mucosal cohorts); Stage 3 stage-stratified analysis (NMIBC vs MIBC subgroup split if clinical metadata supports); cohort expansion (GSE52955 multi-cancer urological + Bryan UK NMIBC + Chen 2022 NMIBC blood EPIC cross-cohort verification); WHI bladder pre-diagnostic n=440+440 biobank-gated cohort remains v1.0+ next-validation-step.

### GitHub state

Commit chain on `hmahaffeyges/IAM-Validation`:
- `404eed3` — Bladder-epic v0.1 sprint sealed (VAL-119 + VAL-120 + VAL-121 + VAL-122). 55 files: 4 atlas vault files (BladderRef bridge script + bridged CSV + Entrez source CSV + README) + 4 VAL directories with prereg + amendment + outcome + script + results JSON + per-sample CSV + cohort manifest + clinical metadata + stratified results each + unified Phase C runner + post-pass.

EDEAR commercial deployment unaffected per CCL-037 throughout. Cookbook-side documentation gates (CHK-2.16 + CHK-2.17 + Parts 23/24 in PIPELINE_REFERENCE) are card-publish-time checks, not deployment-time checks.
