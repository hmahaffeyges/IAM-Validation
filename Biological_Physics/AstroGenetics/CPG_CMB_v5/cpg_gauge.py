...
def render_reference_gauge(tier_breakpoints_path,
    ...
    footer = ("0.95\u20131.04 = healthy band (1.0 = reference center).  Below 0.95 = suppressed / inversion.  "
              f"Above 1.04 = drifting; {bl:.2f} = breach.  Same physics, same ruler as a stellar core "
