# CPG Chain-of-Custody Standard Operating Procedure (SOP) — v1.3.1 (Stages 4.5 + 4.6 + 6-tier breakpoints + smoking/sex foregrounds + immune-atlas residual-map-overlap channel)
