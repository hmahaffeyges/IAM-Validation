...
**Reference:** CPG Plate 1 — `Biological_Physics/Physics_of_Methylation/Plates/CPG_Plate_01_Cosmic_Microwave_Methylome.png`
...
- Stage 4.6 module: `Biological_Physics/RETIRED/PostBuild_atlas_vault_snapshot_2026-06/walther_clinical_runtime/Brightness_Comparison/  (current: CPG_Engine/cpg_patient_cmb.py)patient_brightness_comparison.py`
- Plate 1 reference: `Biological_Physics/Physics_of_Methylation/Plates/CPG_Plate_01_Cosmic_Microwave_Methylome.png`
