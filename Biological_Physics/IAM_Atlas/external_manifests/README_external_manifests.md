...
**Used by:** `Biological_Physics/IAM_Atlas/healpix_mapping/generate_cpg_healpix_mapping.py` — the one-time generator for `iamatlas_cpg_to_healpix_nside128.npy` (the Stage 4.6 patient Mollweide projection mapping).
