...
|---|---|---|---|---|
| [`stage1_betas_GSE87571.pkl.xz`](stage1_betas_GSE87571.pkl.xz) | Uppsala | 80 (40 build panel + 40 held out) | 125,323 | laboratory zero, healthy band, per-entry references, sky residual scale |
| [`stage1_betas_GSE42861.pkl.xz`](stage1_betas_GSE42861.pkl.xz) | Karolinska | 78 | 125,263 | laboratory zero, healthy band, per-entry references, sky residual scale |
| [`stage1_betas_GSE111629.pkl.xz`](stage1_betas_GSE111629.pkl.xz) | UCLA | 80 | 123,913 | laboratory zero, healthy band, per-entry references, sky residual scale |
| [`stage1_betas_GSE125105.pkl.xz`](stage1_betas_GSE125105.pkl.xz) | Munich | 80 | 115,691 | laboratory zero, healthy band, per-entry references, sky residual scale |
