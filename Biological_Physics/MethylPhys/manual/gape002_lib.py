...
# ── page blocks extracted from Issue 002 build() ─────────────────────────────
def blk_cover_002(story):
    # PAGE 1: COVER
    # ══════════════════════════════════════════════════════════════════════════
...
def blk_bodytemp_saturation(story):
...
def blk_master_predictions(story):
    # ══════════════════════════════════════════════════════════════════════════
    story.append(PageBreak())
