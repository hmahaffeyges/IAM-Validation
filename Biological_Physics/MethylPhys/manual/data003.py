...
ENGINE_MAP = [  # stage, files, status at HEAD, what it does (from source), covered in Issue 003?
 ...
 ("Stage 2 — Deconvolution", "Walther_iam_deconvolver/walther_iam_deconvolver.py, MethylPhys/atlas/*", "BUILT (NILC cut 2026-07-02)", "NNLS class + cell fractions; composition/presence; gates no call", "YES — §2.4, §3.2, PROC-DECON-01, PROC-PLASMA-MIX-01"),
