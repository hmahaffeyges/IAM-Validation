...
| [`PROC_MF_01.py`](PROC_MF_01.py) |  |
| [`PROC_MF_02.py`](PROC_MF_02.py) |  |
| [`PROC_MF_03.py`](PROC_MF_03.py) |  |
| [`PROC_MF_03_extract.py`](PROC_MF_03_extract.py) |  |
...
| [`sync_components.py`](sync_components.py) | keeps COMPONENT_MAP's runtime-file section in step with what the code reads |
...
_72 file(s)._ Paths above are relative to this folder, and [`kit/link_check.py`](../kit/link_check.py) fails the build if any of them stops resolving.
