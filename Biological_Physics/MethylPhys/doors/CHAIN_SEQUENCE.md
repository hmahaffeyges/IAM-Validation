...
| 11 | `Stage 1 - IDAT calibration` | `stage_1_idat_calibration.py` | Stage 1 - IDAT calibration to beta (SOP Stage 1, steps 1.1-1.2 + 1.5) _called by run_sample.py when given --grn/--red; skipped when given --betas_ |
