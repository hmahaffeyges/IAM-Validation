...
MAP={
 ...
 "walther_patient_report_builder.py":("RENAME","MethylPhys_Interface/build_methylphys.py","the report the chain renders"),
 "walther_report_builder.py":("RENAME","MethylPhys_Interface/build_methylphys.py","the report the chain renders"),
