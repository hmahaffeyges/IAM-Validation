...
# 2026-09-19 layout patch: resolve the atlas from the repository (Biological_Physics/MethylPhys/atlas/), not a machine path.
...
# manifest in MethylPhys/atlas/external_manifests when present, else leave them absent (only used for per-chromosome panels).
ATLAS_PATH = str(_P(__file__).resolve().parent.parent.parent / "atlas" / "IAMAtlasREBUILD.csv")
