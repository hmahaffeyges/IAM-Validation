...
- Push scope: `Biological_Physics/CPG_Engine/...` (2026-09-19 layout; formerly AstroGenetics/CPG_KISS_Commercial_Engine). `RETIRED/` read-only. Version-bump, one canonical copy.
