...
<h3>The levels</h3><table class='t'><tr><th>level</th><th>on the gauge</th><th>what it means</th></tr>"""]
    ...
    H.append("<h3>The saturation chart - 8 classes x 5 substrates, and which cells are capped below breach</h3>"
      ...
      + "</table>"
      f"<p class='m'><b>15 of the 40 combinations are capped below breach.</b> Nucleosome occupancy caps 7 of the 8 classes (its floors are all near 0.98-0.99, so there is almost no range above healthy before saturation); fuzziness and WPS cap the three stem and progenitor classes; and on methylation - the one lit column - <b>pluripotent stem is capped at 1.018</b>, which is below breach and barely above the healthy band, so a pluripotent-stem breach cannot be read on methylation at all. The two remaining reference clusters in the breakpoints file sit past every methylation ceiling but one: senescent cells at {R['tiers']['tier_system_v1_2']['reference_clusters_past_breach']['senescent_cells']['a_low']}-{R['tiers']['tier_system_v1_2']['reference_clusters_past_breach']['senescent_cells']['a_high']} and malignant cells at {R['tiers']['tier_system_v1_2']['reference_clusters_past_breach']['malignant_cells']['a_low']}-{R['tiers']['tier_system_v1_2']['reference_clusters_past_breach']['malignant_cells']['a_high']}, against a terminal-class methylation ceiling of {1.0/R['hmin_table']['terminal'][0]:.3f} - i.e. those clusters are reachable on the terminal class and on no other class's methylation surface. Which class each cluster was measured on is worth stating explicitly wherever they are quoted; on this chain they are carried as the corpus's reference values and have not been re-measured.</p>")
