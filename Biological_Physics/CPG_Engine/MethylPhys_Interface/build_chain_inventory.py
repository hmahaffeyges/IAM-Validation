...
Output: CPG_Engine/Runtime Matrices/chain_inventory_v1.json
"""
...
DESC.update({
 ...
 "CPG_Chain_of_Custody_SOP_v2_0_0.md":("guard","The SOP: the procedure the chain implements, step by step. Being rewritten to the real file names.","door"),
...
def main():
    ...
    for dp,dn,fs in os.walk(BIO):
        ...
        for f in sorted(fs):
            ...
            if role=="UNDESCRIBED" and (f.startswith(("PROC_","VAL_","test_")) or "/Testing_and_Code/" in p or "/Papers/" in p or "/Issue003/" in p or "/Plates/" in p):
