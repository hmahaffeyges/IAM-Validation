...
\\hline\
Cosmology (baseline) & IAM fits BAO + $f\\sigma_8$ data better than $\\Lambda$CDM & Already tested: $\\Delta\\chi^2 = 32.09$ (\\cite\{Mahaffey2026\}) \\\\\
\\hline\
\\end\{tabular\}\
