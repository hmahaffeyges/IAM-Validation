...
Key finding: The Hubble tension reflects measurements of two distinct expansion rates—photons (CMB) probe β_γ ≈ 0, matter (BAO, distance ladder) probes β_m = 0.18.
...
bashpython tests/test_27_cmb_lensing_FIXED.py
```
...
Key finding: Lensing naturally compensates 85% of the acoustic scale modification. The remaining 15% is resolved by β_γ ≈ 0.

Test 28: Dual-Sector Parameterization
Purpose: Determine best-fit β_γ to restore CMB consistency.
bashpython tests/test_28_dual_sector.py
```
...
bashpython tests/test_29_beta_gamma_constraint.py
```
...
Sector separation is measurable
...
Lensing provides natural consistency
...
Both H₀ and S₈ tensions resolved
...
bashpython tests/test_26_dA_path_breakdown.py
```
...
CMB-S4 (2030s): Will constrain β_γ < 0.001
Euclid (2025-2030): S₈ = 0.78 ± 0.01
DESI Year 5 (2029): β_m to ±1% precision
Lensing power spectrum: 0.87% suppression at ℓ ~ 100-1000


🤝 How to Cite
If you use this code or results, please cite:
bibtex@article{Mahaffey2026,
...
Key finding: The Hubble tension reflects measurements of two distinct expansion rates. Planck (photon sector) and SH0ES (matter sector) are both correct—they probe different physical quantities with empirically constrained ratio β_γ/β_m < 0.022 (95% CL).
