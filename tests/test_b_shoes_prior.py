#!/usr/bin/env python3
"""
TEST B: Pantheon+ SNe with SH0ES (Matter) H₀ Prior
Tests if SNe prefer matter-sector expansion (β_m → +0.16)
"""
...
print("="*80)
print("TEST B: PANTHEON+ WITH SH0ES (MATTER) H₀ PRIOR")
print("="*80)
print()
...
def chi2_IAM(params):
    ...
    # SH0ES H₀ PRIOR (matter sector)
    chi2_H0 = ((H0 - H0_SH0ES) / H0_SH0ES_err)**2
    
    return chi2_sne + chi2_H0

print("Fitting with SH0ES H₀ = 73.04 ± 1.04 km/s/Mpc...")
t0 = time.time()
