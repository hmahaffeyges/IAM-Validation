...
|---|---|---|
| **breast-epic v3.0** | CPG-VAL-008 → CPG-VAL-014 | **DEFERRED — AD-immune is next active series (2026-06-02 decision).** Foundation work for the breast card is complete (CPG-VAL-001/002/003/005/007 + null suite seals + card v3.0 + matrix v1.5 row). The Family B confirmation series resumes after AD-immune. |
| **AD-immune** | TBD slot numbers | ⏳ **NEXT** — pending Heath's AD card from pre-build work. |
