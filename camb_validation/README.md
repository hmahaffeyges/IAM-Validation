...
| sigma_8 | 0.7998 +/- 0.006 | 0.8087 +/- 0.006 | -1.51 sigma |
...
All standard cosmological parameters shift by less than 0.1 sigma. sigma_8 shifts from 0.809 to 0.800, a 1.5 sigma downward shift consistent with the direction reported by weak lensing surveys (KiDS, DES, HSC). The sigma_8 suppression is confirmed as real growth physics (Possibility A): logA shift = 0.09 sigma, Omega_m shift = 0.05 sigma -- both negligible, ruling out parameter rebalancing as the source of suppression.
...
Run D parameters: sigma_8 = 0.7995 +/- 0.006, H0 = 67.189 +/- 0.460. All standard parameters shift by less than 0.1 sigma relative to Run C. The CMB component slightly prefers IAM (Delta-chi2 = -0.16). The RSD component shows Delta-chi2 = +3.08, driven primarily by the z = 0.850 outlier point (LCDM pull = 1.40 sigma) which both models struggle with.
...
|-----------|-------|-------|-----------|
| logA shift | 0.09 sigma | 0.06 sigma | < 0.3 sigma |
| Omega_m shift | 0.05 sigma | 0.00 sigma | < 0.3 sigma |
