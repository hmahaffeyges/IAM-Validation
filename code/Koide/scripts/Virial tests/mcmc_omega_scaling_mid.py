...
print("=" * 70)
print("IAM VIRIAL SCALING TEST: Om_m = 0.315 (SDSS/BOSS/eBOSS)")
print("=" * 70)
print()
...
np.savez('mcmc_results_omega_scaling_mid.npz',
         samples=samples,
         beta_m=beta_m_mcmc,
         beta_gamma=beta_gamma_mcmc)

print("Results saved to: mcmc_results_omega_scaling_mid.npz")
print()
...
fig.suptitle('IAM Virial Scaling Test: Ω_m = 0.315', fontsize=14, y=1.02)
plt.savefig('mcmc_iam_corner_omega_scaling_mid.pdf', bbox_inches='tight', dpi=300)
plt.savefig('mcmc_iam_corner_omega_scaling_mid.png', bbox_inches='tight', dpi=150)
